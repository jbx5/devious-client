...
public final class Player extends Actor {
    ...
    @ObfuscatedName("s")
    @ObfuscatedGetter(intValue = -1229040637)
    @Export("headIconPk")
    int headIconPk;

    @ObfuscatedName("e")
    @ObfuscatedGetter(intValue = 378877663)
    ...
    @ObfuscatedName("i")
    @ObfuscatedGetter(intValue = -1196180537)
    @Export("combatLevel")
    int combatLevel;

    @ObfuscatedName("w")
    @ObfuscatedGetter(intValue = 2144897369)
    @Export("skillLevel")
    int skillLevel;

    @ObfuscatedName("v")
    @ObfuscatedGetter(intValue = 1790396467)
    @Export("tileHeight")
    int tileHeight;

    @ObfuscatedName("a")
    @ObfuscatedGetter(intValue = 5972609)
    @Export("animationCycleStart")
    int animationCycleStart;

    @ObfuscatedName("y")
    @ObfuscatedGetter(intValue = -451757955)
    @Export("animationCycleEnd")
    int animationCycleEnd;

    @ObfuscatedName("u")
    @ObfuscatedGetter(intValue = -1679747591)
    int field1075;

    @ObfuscatedName("h")
    @ObfuscatedGetter(intValue = -1673748563)
    @Export("tileHeight2")
    int tileHeight2;

    @ObfuscatedName("q")
    @ObfuscatedGetter(intValue = 1458594827)
    int field1077;
    ...
    @ObfuscatedName("p")
    @ObfuscatedGetter(intValue = -64519035)
    @Export("minX")
    int minX;

    @ObfuscatedName("n")
    @ObfuscatedGetter(intValue = 1116523143)
    @Export("minY")
    int minY;

    @ObfuscatedName("m")
    @ObfuscatedGetter(intValue = 145100775)
    @Export("maxX")
    int maxX;

    @ObfuscatedName("d")
    @ObfuscatedGetter(intValue = 894137499)
    @Export("maxY")
    int maxY;
    ...
    @ObfuscatedName("f")
    @ObfuscatedGetter(intValue = -1965287033)
    @Export("team")
    int team;
    ...
    @ObfuscatedName("t")
    @ObfuscatedGetter(intValue = 56842439)
    @Export("plane")
    int plane;

    @ObfuscatedName("k")
    @ObfuscatedGetter(intValue = -1237565359)
    @Export("index")
    int index;
    ...
    @ObfuscatedName("ak")
    @ObfuscatedGetter(intValue = 2024062865)
    @Export("tileX")
    int tileX;

    @ObfuscatedName("av")
    @ObfuscatedGetter(intValue = -1738196589)
    @Export("tileY")
    int tileY;
    ...
    @ObfuscatedName("c")
    @ObfuscatedSignature(descriptor = "(Lpi;I)V", garbageValue = "-1567808519")
    @Export("read")
            ...
            if (var3 == null) {
                ...
                if ((!this.isUnanimated) && (this.model0 != null)) {
                    ...
                    if ((Client.cycle >= this.animationCycleStart) && (Client.cycle < this.animationCycleEnd)) {
                        var4 = this.model0;
                        var4.offsetBy(this.field1075 - super.x, this.tileHeight2 - this.tileHeight, this.field1077 - super.y);
                        ...
                        var4.offsetBy(super.x - this.field1075, this.tileHeight - this.tileHeight2, super.y - this.field1077);
                    }
                }
    ...
    @ObfuscatedName("s")
    @ObfuscatedSignature(descriptor = "(I)Z", garbageValue = "-716281640")
    @Export("isFriend")
    boolean isFriend() {
    ...
    @ObfuscatedName("e")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "2053260559")
    ...
    @ObfuscatedName("r")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "179876428")
    ...
    @ObfuscatedName("o")
    @ObfuscatedSignature(descriptor = "(I)Z", garbageValue = "1426624736")
    ...
    @ObfuscatedName("y")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "1638628990")
    @Export("updateIsInFriendsChat")
    void updateIsInFriendsChat() {
        this.isInFriendsChat = ((class67.friendsChat != null) && class67.friendsChat.contains(this.username)) ? TriBool.TriBool_true : TriBool.TriBool_false;
    }

    @ObfuscatedName("u")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "-1606395580")
    ...
    @ObfuscatedName("h")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "162856621")
    void method2105() {
        this.isInClanChat = TriBool.TriBool_unknown;
    }

    @ObfuscatedName("q")
    @ObfuscatedSignature(descriptor = "(I)Z", garbageValue = "1292882175")
    @Export("isClanMember")
    ...
    @ObfuscatedName("x")
    @ObfuscatedSignature(descriptor = "(B)I", garbageValue = "89")
    ...
    @ObfuscatedName("p")
    @ObfuscatedSignature(descriptor = "(IILgl;I)V", garbageValue = "-726114570")
    ...
    @ObfuscatedName("m")
    @ObfuscatedSignature(descriptor = "(IILgl;B)V", garbageValue = "-51")
    ...
    @ObfuscatedName("kj")
    @ObfuscatedSignature(descriptor = "([Ljz;II)V", garbageValue = "-1598355358")
