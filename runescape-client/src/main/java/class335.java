...
public class class335 {
	...
	static int method6600(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.CHAT_GETFILTER_PUBLIC) {
			...
			PacketBufferNode var13 = class503.getPacketBufferNode(ClientPacket.field3181, Client.packetWriter.isaacCipher);
			...
			if (var0 == ScriptOpcodes.CHAT_SENDABUSEREPORT) {
				...
				var6 = class503.getPacketBufferNode(ClientPacket.field3118, Client.packetWriter.isaacCipher);
				...
				if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYTYPEANDLINE) {
					...
					if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYUID) {
						...
						if (var0 == ScriptOpcodes.CHAT_SENDPUBLIC) {
							...
							var12 = class503.getPacketBufferNode(ClientPacket.field3149, Client.packetWriter.isaacCipher);
