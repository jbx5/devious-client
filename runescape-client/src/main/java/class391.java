...
public class class391 implements class396 {
	...
	@ObfuscatedSignature(descriptor = "(Loz;)V")
	public class391(class392 var1) {
		this(new class421(var1));
	}

	@ObfuscatedName("c")
	@ObfuscatedSignature(descriptor = "(II)I", garbageValue = "-275089160")
	public int method7055(int var1) {
		return this.field4424.vmethod7440(var1);
	}
}