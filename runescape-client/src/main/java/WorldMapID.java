		...
		if (var3 > var0.npcCount) {
			...
			for (var3 = 0; var3 < Client.npcCount; ++var3) {
				...
				if ((var6 & 65536) != 0) {
					...
					var5.turnRightSequence = (var7 & 2) != 0 ? var2.readUnsignedIntME() : var5.definition.turnRightSequence;
					var5.walkSequence = (var7 & 4) != 0 ? var2.method9599() : var5.definition.walkSequence;
					var5.walkBackSequence = (var7 & 8) != 0 ? var2.readUnsignedShortAdd() : var5.definition.walkBackSequence;
					var5.walkLeftSequence = (var7 & 16) != 0 ? var2.method9599() : var5.definition.walkLeftSequence;
					var5.walkRightSequence = (var7 & 32) != 0 ? var2.readUnsignedShortAdd() : var5.definition.walkRightSequence;
					var5.runSequence = (var7 & 64) != 0 ? var2.method9599() : var5.definition.field2000;
					var5.field1262 = (var7 & 128) != 0 ? var2.readUnsignedShortAdd() : var5.definition.field2006;
					var5.field1219 = (var7 & 256) != 0 ? var2.method9599() : var5.definition.field2002;
					var5.field1202 = (var7 & 512) != 0 ? var2.readUnsignedIntME() : var5.definition.field2029;
					var5.field1205 = (var7 & 1024) != 0 ? var2.readUnsignedIntME() : var5.definition.field2004;
					...
					var5.idleSequence = (var7 & 16384) != 0 ? var2.readUnsignedIntME() : var5.definition.idleSequence;
				}
					...
					if (var8 > 0) {
						for (var9 = 0; var9 < var8; ++var9) {
							...
							if (var11 != 32767) {
								...
								int var14 = var11 > 0 ? var2.readUnsignedIntIME() : var13;
				...
				if ((var6 & 2048) != 0) {
					...
					var5.field1215 = Client.cycle + var2.readUnsignedIntME();
					var5.field1223 = var2.readByteSub();
					var5.field1254 = var2.readByteAdd();
					var5.field1255 = var2.readByteAdd();
					var5.field1239 = (byte)var2.readUnsignedByteNeg();
				}

				if ((var6 & 16) != 0) {
					var5.definition = class76.getNpcDefinition(var2.method9599());
					class489.method8833(var5);
					var5.method2723();
				}

				if ((var6 & 4096) != 0) {
					var5.method2700(var2.readUnsignedByteNeg());
				}
					...
					if ((var7 & 1) == 1) {
						...
						if ((var7 & 4) == 4) {
							...
							for (var11 = 0; var11 < var10; ++var11) {
								var16[var11] = (short)var2.readUnsignedIntME();
							}
						}
						...
						if ((var7 & 8) == 8) {
							...
							for (var12 = 0; var12 < var11; ++var12) {
								var17[var12] = (short)var2.method9599();
							}
						}
				...
				if ((var6 & 16384) != 0) {
					...
					if ((var7 & 1) == 1) {
						...
						if ((var7 & 4) == 4) {
							...
							for (var11 = 0; var11 < var10; ++var11) {
								var16[var11] = (short)var2.method9599();
							}
						}
						...
						var22 = false;
						if ((var7 & 16) != 0) {
							var22 = var2.readUnsignedIntIME() == 1;
						}
				...
				if ((var6 & 1024) != 0) {
					...
					var5.field1248 = var2.method9599();
					var5.pathLength = 1;
					var5.field1265 = 0;
				...
				if ((var6 & 64) != 0) {
					var7 = var2.readUnsignedIntME();
					var8 = var2.readUnsignedShort();
					var5.field1230 = var2.readUnsignedIntIME() == 1;
					var5.field1252 = var7;
					var5.field1225 = var8;
				}
			}
