...
public enum HorizontalAlignment implements MouseWheel {
	...
	@ObfuscatedName("m")
	@ObfuscatedGetter(intValue = -947111311)
	@Export("value")
	public final int value;

	@ObfuscatedName("t")
	@ObfuscatedGetter(intValue = -968745241)
	@Export("id")
	final int id;
	...
	@ObfuscatedName("c")
	@ObfuscatedSignature(descriptor = "(Lpj;B)V", garbageValue = "13")
	@Export("updatePlayer")
	...
	@ObfuscatedName("t")
	@ObfuscatedSignature(descriptor = "(Ljava/lang/Float;Ljava/lang/Float;I)V", garbageValue = "-2046579641")
