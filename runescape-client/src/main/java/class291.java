...
public class class291 {
	@ObfuscatedName("gr")
	@ObfuscatedSignature(descriptor = "(IIIIB)V", garbageValue = "-109")
	@Export("drawEntities")
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		for (var12 = 0; var12 < 5; ++var12) {
			if (Client.field725[var12]) {
				var13 = ((int) (((Math.random() * ((double) ((Client.field726[var12] * 2) + 1))) - ((double) (Client.field726[var12]))) + (Math.sin((((double) (Client.field618[var12])) / 100.0) * ((double) (Client.field729[var12]))) * ((double) (Client.field679[var12])))));
				if (var12 == 0) {
