...
public class PacketBufferNode extends Node {
    ...
    @ObfuscatedName("o")
    @ObfuscatedGetter(intValue = 2107144477)
    ...
    @ObfuscatedName("l")
    @ObfuscatedGetter(intValue = 159088945)
    ...
    @ObfuscatedName("e")
    @ObfuscatedGetter(intValue = -15994369)
    @Export("index")
    public int index;
    ...
    @ObfuscatedName("l")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "-801745913")
    @Export("release")
    public void release() {
    ...
    @ObfuscatedName("gg")
    @ObfuscatedSignature(descriptor = "(ZI)V", garbageValue = "585881106")
