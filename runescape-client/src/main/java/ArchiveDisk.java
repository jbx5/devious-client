...
public final class ArchiveDisk {
    ...
    @ObfuscatedName("e")
    @ObfuscatedGetter(intValue = -33570107)
    @Export("archive")
    int archive;

    @ObfuscatedName("r")
    @ObfuscatedGetter(intValue = -1234319429)
    @Export("maxEntrySize")
    int maxEntrySize;
    ...
    @ObfuscatedSignature(descriptor = "(ILoa;Loa;I)V")
    ...
    @ObfuscatedName("c")
    @ObfuscatedSignature(descriptor = "(IS)[B", garbageValue = "128")
    @Export("read")
    ...
    @ObfuscatedName("l")
    @ObfuscatedSignature(descriptor = "(I[BII)Z", garbageValue = "831573355")
    @Export("write")
    ...
    @ObfuscatedName("s")
    @ObfuscatedSignature(descriptor = "(I[BIZI)Z", garbageValue = "-463275896")
    @Export("write0")
