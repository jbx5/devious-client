		...
		for (int var1 = 0; var1 < Client.npcCount; ++var1) {
			...
			if ((((var2 != null) && var2.isVisible()) && (var2.definition.isVisible == var0)) && var2.definition.transformIsVisible()) {
				...
				if ((((var3 >= 0) && (var3 < 104)) && (var4 >= 0)) && (var4 < 104)) {
					if (((var2.field1150 == 1) && ((var2.x & 127) == 64)) && ((var2.y & 127) == 64)) {
					...
					ArchiveLoader.scene.drawEntity(class18.Client_plane, var2.x, var2.y, WorldMapLabel.getTileHeight(((var2.field1150 * 64) - 64) + var2.x, ((var2.field1150 * 64) - 64) + var2.y, class18.Client_plane), ((var2.field1150 * 64) - 64) + 60, var2, var2.rotation, var5, var2.isWalking);
				}
			}
		}
