...
public class ModelData extends Renderable {
    ...
    @ObfuscatedSignature(descriptor = "(Lgq;ZZZZ)V", garbageValue = "1")
    ...
    @ObfuscatedName("a")
    @ObfuscatedSignature(descriptor = "(Lgq;I)I")
    ...
    @ObfuscatedName("u")
    @ObfuscatedSignature(descriptor = "([[IIIIZI)Lgq;")
    public ModelData method3707(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
        this.calculateBounds();
        int var7 = var2 + this.field2189;
        int var8 = var2 + this.field2190;
    ...
    @ObfuscatedName("ap")
    @ObfuscatedSignature(descriptor = "(IIIII)Lgf;")
    @Export("toModel")
    ...
    @ObfuscatedName("c")
    @ObfuscatedSignature(descriptor = "(Lkq;II)Lgq;")
    ...
    @ObfuscatedName("z")
    @ObfuscatedSignature(descriptor = "(Lgq;Lgq;IIIZ)V")
    static void method3701(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
        ...
        for (var9 = 0; var9 < var0.verticesCount; ++var9) {
            ...
            if (var10.magnitude != 0) {
                ...
                if (var11 <= var1.field2188) {
                    int var12 = var0.verticesX[var9] - var2;
                    if ((var12 >= var1.field2189) && (var12 <= var1.field2190)) {
