...
public class ModelData extends Renderable {
	...
	public ModelData method4061(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
		...
		int var7 = var2 + this.field2302; // L: 1149
		int var8 = var2 + this.field2303; // L: 1150
		int var9 = var4 + this.field2292; // L: 1151
		int var10 = var4 + this.field2300; // L: 1152
	...
	void calculateBounds() {
		if (!this.isBoundsCalculated) { // L: 1412
			...
			this.field2294 = 0; // L: 1414
			this.field2302 = 999999; // L: 1415
			this.field2303 = -999999; // L: 1416
			this.field2300 = -99999; // L: 1417
			this.field2292 = 99999; // L: 1418
			...
			for (int var1 = 0; var1 < this.verticesCount; ++var1) { // L: 1419
				...
				if (var2 < this.field2302) { // L: 1423
					this.field2302 = var2;
				}

				if (var2 > this.field2303) { // L: 1424
					this.field2303 = var2;
				}

				if (var4 < this.field2292) { // L: 1425
					this.field2292 = var4;
				}

				if (var4 > this.field2300) { // L: 1426
					this.field2300 = var4;
				}
	...
	static void method4085(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
		...
		for (var9 = 0; var9 < var0.verticesCount; ++var9) { // L: 1442
			...
			if (var10.magnitude != 0) { // L: 1444
				...
				if (var11 <= var1.field2294) { // L: 1446
					int var12 = var0.verticesX[var9] - var2; // L: 1447
					if (var12 >= var1.field2302 && var12 <= var1.field2303) { // L: 1448
						int var13 = var0.verticesZ[var9] - var4; // L: 1449
						if (var13 >= var1.field2292 && var13 <= var1.field2300) { // L: 1450
