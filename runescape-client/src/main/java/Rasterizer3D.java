...
public class Rasterizer3D extends Rasterizer2D {
   @ObfuscatedName("a")
   static boolean field2420 = false;
   @ObfuscatedName("f")
   static boolean field2430 = false;
   @ObfuscatedName("c")
   @Export("Rasterizer3D_isLowDetailTexture")
   static boolean Rasterizer3D_isLowDetailTexture = false;
   @ObfuscatedName("x")
   public static boolean field2414 = true;
   @ObfuscatedName("h")
   ...
   @ObfuscatedName("g")
   static int[] field2433 = new int[512];
   @ObfuscatedName("k")
   static int[] field2423 = new int[2048];
   @ObfuscatedName("v")
