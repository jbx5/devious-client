...
public class Rasterizer2D extends DualNode {
	...
	@ObfuscatedName("ed")
	protected static void method9971(int[] var0, int var1, int var2, float[] var3) {
	...
	public static void method9994() {
		if (field5415 != null) {
			...
			if (Rasterizer2D_xClipStart == 0 && Rasterizer2D_xClipEnd == Rasterizer2D_width && Rasterizer2D_yClipStart == 0 && Rasterizer2D_yClipEnd == Rasterizer2D_height) {
				var0 = field5415.length;
				var1 = var0 - (var0 & 7);

				for (var2 = 0; var2 < var1; field5415[var2++] = 0.0F) {
					field5415[var2++] = 0.0F;
					field5415[var2++] = 0.0F;
					field5415[var2++] = 0.0F;
					field5415[var2++] = 0.0F;
	...
	public static void method9995() {
		if (field5415 != null) {
			int var0 = field5415.length;

			for (int var1 = 0; var1 < var0; ++var1) {
				if (var1 % Rasterizer2D_width < Rasterizer2D_width / 2 && field5415[var1] > 0.0F) {
					int var2 = (int)(255.0F * WorldMapID.method5944(field5415[var1]));
