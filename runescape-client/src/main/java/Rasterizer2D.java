...
public class Rasterizer2D extends DualNode {
	...
	public static void method9619() {
		if (field5304 != null) {
			...
			if (Rasterizer2D_xClipStart == 0 && Rasterizer2D_xClipEnd == Rasterizer2D_width && Rasterizer2D_yClipStart == 0 && Rasterizer2D_yClipEnd == Rasterizer2D_height) {
				var0 = field5304.length;
				var1 = var0 - (var0 & 7);

				for (var2 = 0; var2 < var1; field5304[var2++] = 0.0F) {
					field5304[var2++] = 0.0F;
					field5304[var2++] = 0.0F;
					field5304[var2++] = 0.0F;
					field5304[var2++] = 0.0F;
	...
	public static void method9605() {
		if (field5304 != null) {
			int var0 = field5304.length;

			for (int var1 = 0; var1 < var0; ++var1) {
				if (var1 % Rasterizer2D_width < Rasterizer2D_width / 2 && field5304[var1] > 0.0F) {
					int var2 = (int)(255.0F * class127.method2957(field5304[var1]));
