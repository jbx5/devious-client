...
public class ByteArrayPool {
	@ObfuscatedName("t")
	@ObfuscatedGetter(intValue = 1756482419)
	@Export("ByteArrayPool_smallCount")
	static int ByteArrayPool_smallCount;

	@ObfuscatedName("s")
	@ObfuscatedGetter(intValue = 379141881)
	@Export("ByteArrayPool_mediumCount")
	static int ByteArrayPool_mediumCount;

	@ObfuscatedName("j")
	@ObfuscatedGetter(intValue = 173834125)
	@Export("ByteArrayPool_largeCount")
	static int ByteArrayPool_largeCount;

	@ObfuscatedName("w")
	@ObfuscatedGetter(intValue = -521742755)
	static int field4026;

	@ObfuscatedName("n")
	@ObfuscatedGetter(intValue = -1862899705)
	static int field4023;

	@ObfuscatedName("r")
	@ObfuscatedGetter(intValue = 1634057369)
	static int field4028;

	@ObfuscatedName("o")
	@ObfuscatedGetter(intValue = 1124968779)
	static int field4021;

	@ObfuscatedName("v")
	@ObfuscatedGetter(intValue = -1777784581)
	...
	@ObfuscatedName("c")
	@ObfuscatedSignature(descriptor = "(IZS)[B", garbageValue = "-3055")
	...
	@ObfuscatedName("t")
	@ObfuscatedSignature(descriptor = "(IZB)Ljava/lang/String;", garbageValue = "43")
	@Export("intToString")
