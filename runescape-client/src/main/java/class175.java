...
public class class175 {
	...
	class175(class185 var1) {
		this.this$0 = var1;
		this.field1866 = new float[4];
	}
	...
	static final float method3578(int var0) {
	...
	@ObfuscatedSignature(
		...
		garbageValue = "-1861171417"
	)
	static Date method3579() {
	...
	public static final SpritePixels getItemSprite(int var0, int var1, int var2, int var3, int var4, boolean var5) {
		...
		if (var20 == null) {
			...
			float[] var15 = Rasterizer2D.field5415;
			int[] var16 = new int[4];
			Rasterizer2D.Rasterizer2D_getClipArray(var16);
			var8 = new SpritePixels(36, 32);
			Rasterizer3D.method4691(var8.pixels, 36, 32, (float[])null);
			Rasterizer2D.Rasterizer2D_clear();
			Rasterizer3D.resetRasterClipping();
			Rasterizer3D.method4695(16, 16);
			...
			if (var4 == 1 || var4 == 2 && var9.isStackable == 1) {
				VarbitComposition.ItemDefinition_fontPlain11.draw(LoginScreenAnimation.method2500(var1), 0, 9, 16776960, 1);
			}
			...
			Rasterizer3D.method4691(var12, var13, var14, var15);
	...
	@ObfuscatedSignature(
		...
		garbageValue = "-1820321748"
	)
	static void method3576(int var0, String var1) {
