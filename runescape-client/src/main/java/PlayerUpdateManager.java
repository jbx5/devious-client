...
public class PlayerUpdateManager {
	...
	final void updatePlayer(PacketBuffer var1, boolean var2) {
		...
		if (var2) {
			...
			class17.localPlayer.worldView = this.worldView;
		}
		...
		for (int var9 = 1; var9 < 2048; ++var9) {
			if (var4 != var9) {
				...
				int var13 = var10 & 597;
				this.Players_regions[var9] = (var12 << 14) + var13 + (var11 << 28);
	...
	void readPlayerUpdate(PacketBuffer var1, int var2) {
		...
		if (var4 == 0) {
			if (var3) {
				...
				this.Players_regions[var2] = (var5.plane << 28) + (this.worldView.baseX + var5.pathX[0] >> 13 << 14) + (this.worldView.baseY + var5.pathY[0] >> 13);
				if (var5.field1204 != -1) {
					this.Players_orientations[var2] = var5.field1204;
				} else {
			...
			if (var4 == 1) {
				...
				if (var2 == Client.localPlayerIndex && this.worldView.method2634() && (var5.x < 1536 || var5.y < 1536 || var5.x >= 11776 || var5.y >= 11776)) {
					...
					var5.field1161 = false;
					var5.method2370(this.worldView, var7, var8, this.field1413[var2]);
				}
				...
				if (var6 == 0) {
					...
					if (var2 != Client.localPlayerIndex || !this.worldView.method2634() || var5.x >= 1536 && var5.y >= 1536 && var5.x < 11776 && var5.y < 11776) {
						if (var3) {
							...
							var5.field1161 = false;
							var5.method2370(this.worldView, var11, var12, this.field1413[var2]);
						}
					} else {
					...
					if (var2 == Client.localPlayerIndex && this.worldView.method2634()) {
	...
	boolean method2781(PacketBuffer var1, int var2) {
		...
		if (var3 == 0) {
			...
			this.Players_regions[var2] = (var5 & 268435455) + (((var5 >> 28) + var4 & 3) << 28);
			return false;
		} else {
			int var6;
			int var7;
			if (var3 == 2) {
				...
				this.Players_regions[var2] = (var9 << 14) + var10 + (var8 << 28);
				return false;
			} else {
				...
				var11 = var7 + var8 & 255;
				this.Players_regions[var2] = (var10 << 14) + var11 + (var9 << 28);
				return false;
			}
		}
	}
	...
	final void method2783(PacketBuffer var1, int var2, Player var3, int var4) {
			...
			if (var7 > 0) {
				for (var8 = 0; var8 < var7; ++var8) {
					...
					if (var10 != 32767) {
						...
						var13 = var10 > 0 ? var1.readUnsignedByteAdd() : var23;
		...
		if ((var4 & 2) != 0) {
			...
			PlayerType var21 = (PlayerType)MenuAction.findEnumerated(class108.PlayerType_values(), var1.readUnsignedByteSub());
			...
			if (var3.username != null && var3.appearance != null) {
				...
				if (!var30 && Client.field650 == 0 && !var3.isHidden) {
		...
		if ((var4 & 512) != 0) {
			...
			PlayerType var22 = (PlayerType)MenuAction.findEnumerated(class108.PlayerType_values(), var1.readUnsignedByteNeg());
			...
			if (var3.username != null && var3.appearance != null) {
				...
				if (!var31 && Client.field650 == 0 && !var3.isHidden) {
					this.field1424.offset = 0;
		...
		if ((var4 & 1) != 0) {
			var3.field1204 = var1.readUnsignedShortLE();
		...
		if ((var4 & 2048) != 0) {
			...
			var3.field1266 = Client.cycle + var1.readUnsignedShortLE();
			var3.field1267 = var1.readByteNeg();
			var3.field1268 = var1.readByteSub();
			var3.field1269 = var1.readByte();
			var3.field1270 = (byte)var1.readUnsignedByteAdd();
		}

		if ((var4 & 1024) != 0) {
			var3.field1256 = var1.readByte();
			var3.field1258 = var1.readByteNeg();
			var3.field1257 = var1.readByteSub();
			var3.field1259 = var1.readByteNeg();
			var3.spotAnimation = var1.readUnsignedShort() + Client.cycle;
			var3.field1261 = var1.readUnsignedShortLE() + Client.cycle;
			var3.field1262 = var1.readUnsignedShortAddLE();
			if (var3.field1161) {
				var3.field1256 += var3.tileX;
				var3.field1258 += var3.tileY;
				var3.field1257 += var3.tileX;
				var3.field1259 += var3.tileY;
				var3.pathLength = 0;
			} else {
		...
		if ((var4 & 16) != 0) {
			...
			class162.performPlayerAnimation(var3, var6, var7);
		}

		if ((var4 & 8) != 0) {
			var3.targetIndex = var1.readUnsignedShortLE();
			var3.targetIndex += var1.readUnsignedByteAdd() << 16;
			var6 = 16777215;
		...
		if (var3.field1161) {
			if (var5 == 127) {
				...
				var3.method2370(this.worldView, var3.tileX, var3.tileY, var34);
			}
		}
