...
public class WorldMapData_0 extends AbstractWorldMapData {
	...
	void init(Buffer var1) {
		...
		if (var2 != WorldMapID.field3133.value) {
	...
	public static class469 method5232() {
		synchronized(class469.field4866) {
			if (class277.field3054 == 0) {
				return new class469();
			} else {
				class469.field4866[--class277.field3054].method8381();
				return class469.field4866[class277.field3054];
			}
		}
	}
	...
	public static void invalidateWidget(Widget var0) {
		if (var0 != null && var0.cycle == Client.field731) {
	...
	static String method5235(String var0, boolean var1) {
		...
		String var3 = "";
		if (ViewportMouse.field2868 != null) {
			var3 = "/p=" + ViewportMouse.field2868;
		}

		String var4 = "runescape.com";
		return var2 + var0 + "." + var4 + "/l=" + GraphicsObject.clientLanguage + "/a=" + class276.field3045 + var3 + "/";
	}
}
