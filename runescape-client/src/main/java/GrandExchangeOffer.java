   ...
   static final void method6027() {
      ...
      if (!var0) {
         ...
         for(var1 = 0; var1 < class7.regionLandArchives.length; ++var1) {
            ...
            if (var15 != null) {
               var3 = (FileSystem.regions[var1] >> 8) * 64 - class300.baseX * 64;
         ...
         if (!var0) {
            ...
            if (!Client.isInInstance) {
               ...
               for(var2 = 0; var2 < var1; ++var2) {
                  var3 = (FileSystem.regions[var2] >> 8) * 64 - class300.baseX * 64;
               ...
               for(var2 = 0; var2 < var1; ++var2) {
                  ...
                  if (var13 != null) {
                     var4 = (FileSystem.regions[var2] >> 8) * 64 - class300.baseX * 64;
            ...
            if (class329.client.hasFrame()) {
               var17 = class433.getPacketBufferNode(ClientPacket.field3006, Client.packetWriter.isaacCipher);
