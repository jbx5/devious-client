...
public class VorbisResidue {
	...
	VorbisResidue() {
		...
		this.residueType = var1.method1178(16);
		this.begin = var1.method1178(24);
		this.end = var1.method1178(24);
		this.partitionSize = var1.method1178(24) + 1;
		this.classifications = var1.method1178(6) + 1;
		this.classbook = var1.method1178(8);
		int[] var2 = new int[this.classifications];

		int var3;
		for (var3 = 0; var3 < this.classifications; ++var3) {
			int var4 = 0;
			int var5 = var1.method1178(3);
			boolean var6 = var1.method1166() != 0;
			if (var6) {
		...
		for (var3 = 0; var3 < this.classifications * 8; ++var3) {
			this.cascade[var3] = (var2[var3 >> 3] & 1 << (var3 & 7)) != 0 ? var1.method1178(8) : -1;
		}
	...
	void method898(float[] var1, int var2, boolean var3, class60 var4) {
		...
		if (!var3) {
			var5 = VorbisSample.field347[this.classbook].field341;
			...
			for (int var9 = 0; var9 < 8; ++var9) {
				...
				while (var10 < var7) {
					...
					int var12;
					if (var9 == 0) {
						var11 = VorbisSample.field347[this.classbook].method1081(var4);
					...
					for (var11 = 0; var11 < var5; ++var11) {
						...
						if (var13 >= 0) {
							...
							VorbisCodebook var15 = VorbisSample.field347[var13];
							int var16;
							if (this.residueType == 0) {
								var16 = this.partitionSize / var15.field341;

								for (int var20 = 0; var20 < var16; ++var20) {
									float[] var21 = var15.method1092(var4);
								...
								while (var16 < this.partitionSize) {
									float[] var17 = var15.method1092(var4);
