...
public class VorbisResidue {
	...
	VorbisResidue() {
		...
		this.residueType = var1.method1158(16);
		this.begin = var1.method1158(24);
		this.end = var1.method1158(24);
		this.partitionSize = var1.method1158(24) + 1;
		this.classifications = var1.method1158(6) + 1;
		this.classbook = var1.method1158(8);
		int[] var2 = new int[this.classifications];

		int var3;
		for (var3 = 0; var3 < this.classifications; ++var3) {
			int var4 = 0;
			int var5 = var1.method1158(3);
			boolean var6 = var1.method1153() != 0;
			if (var6) {
				var4 = var1.method1158(5);
			}
		...
		for (var3 = 0; var3 < this.classifications * 8; ++var3) {
			this.cascade[var3] = (var2[var3 >> 3] & 1 << (var3 & 7)) != 0 ? var1.method1158(8) : -1;
		}
	...
	void method883(float[] var1, int var2, boolean var3, class60 var4) {
		int var5;
		...
		if (!var3) {
			...
			for (int var9 = 0; var9 < 8; ++var9) {
				...
				while (var10 < var7) {
					...
					int var12;
					if (var9 == 0) {
						var11 = VorbisSample.field383[this.classbook].method1069(var4);
						...
						if (var13 >= 0) {
							...
							if (this.residueType == 0) {
								...
								for (int var20 = 0; var20 < var16; ++var20) {
									float[] var21 = var15.method1063(var4);
								...
								while (var16 < this.partitionSize) {
									float[] var17 = var15.method1063(var4);
