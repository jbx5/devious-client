...
public class PcmPlayer {
   ...
   static final void method751(PacketBuffer var0) {
      for(int var1 = 0; var1 < Client.field541; ++var1) {
         ...
         if ((var4 & 16) != 0) {
            var3.definition = class125.getNpcDefinition(var0.method7776());
         ...
         if ((var4 & 128) != 0) {
            ...
            if (var6 > 0) {
               for(var7 = 0; var7 < var6; ++var7) {
                  ...
                  if (var9 != 32767) {
                     var10 = var0.readUShortSmart();
                     var11 = var0.method7766();
                     int var12 = var9 > 0 ? var0.method7908() : var11;
         ...
         if ((var4 & 1024) != 0) {
            var3.field1189 = Client.cycle + var0.method7774();
            var3.field1136 = Client.cycle + var0.readUnsignedShort();
            var3.field1191 = var0.method7768();
            var3.field1168 = var0.readByte();
            var3.field1193 = var0.readByte();
            var3.field1184 = (byte)var0.method7908();
         }

         if (ScriptFrame.field462 && (var4 & 512) != 0 || !ScriptFrame.field462 && (var4 & 2) != 0) {
            var3.field1177 = var0.method7769();
            var3.field1182 = var0.method7743();
            var3.field1188 = var0.method7769();
            var3.field1183 = var0.readByte();
            var3.field1194 = var0.method7776() + Client.cycle;
            var3.field1166 = var0.method7776() + Client.cycle;
            var3.field1186 = var0.method7776();
            var3.pathLength = 1;
            var3.field1203 = 0;
         ...
         if ((var4 & 2048) != 0) {
            var3.field1204 = var0.method7787();
         }
      }
