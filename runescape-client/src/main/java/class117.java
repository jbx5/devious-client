...
public class class117 implements MouseWheel {
	@ObfuscatedName("sx")
	@ObfuscatedGetter(intValue = -1106281963)
	...
	@ObfuscatedName("u")
	@ObfuscatedGetter(intValue = -1755047429)
	final int field1441;

	@ObfuscatedName("k")
	@ObfuscatedGetter(intValue = -438304939)
	final int field1426;

	@ObfuscatedName("f")
	@ObfuscatedGetter(intValue = 614342417)
	final int field1443;
	static 
	{
	...
	@ObfuscatedName("p")
	@ObfuscatedSignature(descriptor = "(I)I", garbageValue = "-202233185")
	int method2674() {
