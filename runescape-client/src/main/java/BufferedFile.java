...
public class BufferedFile {
	...
	@ObfuscatedName("at")
	@ObfuscatedGetter(
		longValue = -7787186892209263085L
	)
	...
	@ObfuscatedName("ac")
	@ObfuscatedGetter(
		longValue = 6633076167208672283L
	)
	@Export("offset")
	long offset;
	@ObfuscatedName("ao")
	@ObfuscatedGetter(
		longValue = -6408089809225312719L
	)
	@Export("fileLength")
	long fileLength;
	@ObfuscatedName("ah")
	@ObfuscatedGetter(
		longValue = 2542749063148288171L
	)
	@Export("length")
	long length;
	@ObfuscatedName("av")
	@ObfuscatedGetter(
		longValue = 7154794803375498677L
	)
	@Export("fileOffset")
	long fileOffset;
	...
	void flush() throws IOException {
		if (-1L != this.writeBufferOffset) {
			...
			this.fileOffset += (long)(this.writeBufferLength * 853095299) * 1253438251L;
			if (this.fileOffset > this.fileLength) {
				this.fileLength = this.fileOffset;
			}
