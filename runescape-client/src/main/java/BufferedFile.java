...
public class BufferedFile {
	...
	@ObfuscatedName("am")
	@ObfuscatedGetter(
		longValue = -4478279998810493323L
	)
	...
	@ObfuscatedName("af")
	@ObfuscatedGetter(
		longValue = 6390274326456513839L
	)
	...
	@ObfuscatedName("au")
	@ObfuscatedGetter(
		longValue = -7409537766690830883L
	)
	@Export("offset")
	long offset;
	@ObfuscatedName("ar")
	@ObfuscatedGetter(
		longValue = 8366871520021484299L
	)
	@Export("fileLength")
	long fileLength;
	@ObfuscatedName("al")
	@ObfuscatedGetter(
		longValue = 446602842106707619L
	)
	@Export("length")
	long length;
	@ObfuscatedName("ad")
	@ObfuscatedGetter(
		longValue = -1038774745980389049L
	)
	@Export("fileOffset")
	long fileOffset;
	...
	void flush() throws IOException {
		if (this.writeBufferOffset != -1L) {
			...
			this.fileOffset += 962373833L * (long)(this.writeBufferLength * -329780871);
			if (this.fileOffset > this.fileLength) {
				this.fileLength = this.fileOffset;
			}
