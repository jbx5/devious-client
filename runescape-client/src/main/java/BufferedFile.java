...
public class BufferedFile {
    ...
    @ObfuscatedName("e")
    @ObfuscatedGetter(longValue = 8233706663522758823L)
    @Export("readBufferOffset")
    long readBufferOffset;

    @ObfuscatedName("r")
    @ObfuscatedGetter(intValue = 1952727021)
    ...
    @ObfuscatedName("i")
    @ObfuscatedGetter(longValue = -2674952577267016759L)
    @Export("writeBufferOffset")
    long writeBufferOffset;

    @ObfuscatedName("w")
    @ObfuscatedGetter(intValue = 1279091009)
    @Export("writeBufferLength")
    int writeBufferLength;

    @ObfuscatedName("v")
    @ObfuscatedGetter(longValue = -976954528480245091L)
    @Export("offset")
    long offset;

    @ObfuscatedName("a")
    @ObfuscatedGetter(longValue = 481737759111491477L)
    @Export("fileLength")
    long fileLength;

    @ObfuscatedName("y")
    @ObfuscatedGetter(longValue = 4033264950659232059L)
    @Export("length")
    long length;

    @ObfuscatedName("u")
    @ObfuscatedGetter(longValue = -8501049218549444537L)
    @Export("fileOffset")
    long fileOffset;
    ...
    @ObfuscatedName("s")
    @ObfuscatedSignature(descriptor = "(S)J", garbageValue = "201")
    @Export("length")
    public long length() {
        return this.length;
    }
    ...
    @ObfuscatedName("e")
    @ObfuscatedSignature(descriptor = "([BB)V", garbageValue = "-73")
    @Export("readFully")
    ...
    @ObfuscatedName("r")
    @ObfuscatedSignature(descriptor = "([BIII)V", garbageValue = "-1169331872")
    @Export("read")
    ...
    @ObfuscatedName("o")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "-615316523")
    @Export("load")
    ...
    @ObfuscatedName("i")
    @ObfuscatedSignature(descriptor = "([BIIB)V", garbageValue = "117")
    @Export("write")
    ...
    @ObfuscatedName("w")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "408452491")
    @Export("flush")
    void flush() throws IOException {
        if (this.writeBufferOffset != (-1L)) {
            ...
            this.fileOffset += ((long) (this.writeBufferLength)) * (-1754305857639677951L);
            if (this.fileOffset > this.fileLength) {
                this.fileLength = this.fileOffset;
            }
            long var1 = -1L;
