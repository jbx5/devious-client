...
public class BufferedFile {
	@ObfuscatedName("bh")
	static Image field5280;
	@ObfuscatedName("kk")
	@ObfuscatedSignature(
		descriptor = "[Lvb;"
	)
	static IndexedSprite[] field5281;
	@ObfuscatedName("ay")
	@ObfuscatedSignature(
		descriptor = "Lum;"
	)
	...
	@ObfuscatedName("au")
	@ObfuscatedGetter(
		longValue = -8677045507621820509L
	)
	...
	@ObfuscatedName("am")
	@ObfuscatedGetter(
		longValue = 1857297531961596637L
	)
	...
	@ObfuscatedName("ae")
	@ObfuscatedGetter(
		longValue = -5548070381148018721L
	)
	@Export("offset")
	long offset;
	@ObfuscatedName("ad")
	@ObfuscatedGetter(
		longValue = -7937418277592130769L
	)
	@Export("fileLength")
	long fileLength;
	@ObfuscatedName("aq")
	@ObfuscatedGetter(
		longValue = 1014057439217453929L
	)
	@Export("length")
	long length;
	@ObfuscatedName("al")
	@ObfuscatedGetter(
		longValue = -2919519752114175231L
	)
	@Export("fileOffset")
	long fileOffset;
	...
	void flush() throws IOException {
		if (this.writeBufferOffset != -1L) {
			...
			this.fileOffset += (long)(this.writeBufferLength * 1362427055) * -1369974193L;
			if (this.fileOffset > this.fileLength) {
				this.fileLength = this.fileOffset;
			}
