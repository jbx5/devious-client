...
public class WorldMap {
	...
	@ObfuscatedName("v")
	@ObfuscatedSignature(descriptor = 
	"(Lln;Lln;Lln;Lmd;Ljava/util/HashMap;[Lqq;B)V", garbageValue = 
	"-57")
