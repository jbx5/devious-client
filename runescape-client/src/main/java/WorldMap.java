      ...
      if (this.currentMapArea != null) {
         ...
         if (this.mouseCoord != null && var3) {
            ...
            if (var8 && KeyHandler.KeyHandler_pressedKeys[82] && KeyHandler.KeyHandler_pressedKeys[81]) {
               ...
               PacketBufferNode var12 = class433.getPacketBufferNode(ClientPacket.field3016, Client.packetWriter.isaacCipher);
               var12.packetBuffer.method7762(var11);
               var12.packetBuffer.method7784(0);
               var12.packetBuffer.method7773(var10);
               var12.packetBuffer.method7773(var14);
               ...
               if (var9) {
                  ...
                  var13.packetBuffer.method7784(this.mouseCoord.packed());
