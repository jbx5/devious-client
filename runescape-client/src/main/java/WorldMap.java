...
public class WorldMap {
	...
	@ObfuscatedName("v")
	@ObfuscatedSignature(descriptor = 
	"(Llq;Llq;Llq;Lmr;Ljava/util/HashMap;[Lqx;B)V", garbageValue = 
	"16")
