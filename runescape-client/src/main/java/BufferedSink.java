...
public class BufferedSink implements Runnable {
	@ObfuscatedName("mk")
	@ObfuscatedGetter(intValue = -719644833)
	@Export("menuY")
	static int menuY;
	...
	@ObfuscatedName("p")
	@ObfuscatedGetter(intValue = 345474963)
	@Export("capacity")
	int capacity;
	...
	@ObfuscatedName("t")
	@ObfuscatedGetter(intValue = 2075331091)
	@Export("position")
	int position;

	@ObfuscatedName("s")
	@ObfuscatedGetter(intValue = 154665981)
	@Export("limit")
	int limit;
	...
	@ObfuscatedName("c")
	@ObfuscatedSignature(descriptor = "(I)Z", garbageValue = "1810348727")
	@Export("isClosed")
	boolean isClosed() {
		if (this.closed) {
			try {
	...
	@ObfuscatedName("b")
	@ObfuscatedSignature(descriptor = "([BIII)V", garbageValue = "103815641")
	@Export("write")
	...
	@ObfuscatedName("p")
	@ObfuscatedSignature(descriptor = "(I)V", garbageValue = "784609340")
	@Export("close")
	void close() {
		synchronized(this) {
			this.closed = true;
	...
	@ObfuscatedName("h")
	@ObfuscatedSignature(descriptor = "(ILbn;ZI)I", garbageValue = "-1853043366")
