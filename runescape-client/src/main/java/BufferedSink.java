...
public class BufferedSink implements Runnable {
    ...
    @ObfuscatedName("s")
    @ObfuscatedGetter(intValue = -1231606927)
    @Export("capacity")
    int capacity;
    ...
    @ObfuscatedName("r")
    @ObfuscatedGetter(intValue = -1144762949)
    @Export("position")
    int position;

    @ObfuscatedName("o")
    @ObfuscatedGetter(intValue = -515609021)
    @Export("limit")
    int limit;
    ...
    @ObfuscatedName("c")
    @ObfuscatedSignature(descriptor = "(I)Z", garbageValue = "-1120914050")
    @Export("isClosed")
    boolean isClosed() {
        if (this.closed) {
            try {
    ...
    @ObfuscatedName("l")
    @ObfuscatedSignature(descriptor = "([BIII)V", garbageValue = "-1714956737")
    @Export("write")
    ...
    @ObfuscatedName("s")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "-775633703")
    @Export("close")
    void close() {
        synchronized(this) {
            this.closed = true;
