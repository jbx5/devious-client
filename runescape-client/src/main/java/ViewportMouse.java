...
public class ViewportMouse {
	...
	static int method4514(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.CC_SETONCLICK) {
			...
			if (var0 == ScriptOpcodes.CC_SETONHOLD) {
				var3.onHold = var8;
			} else
				if (var0 == ScriptOpcodes.CC_SETONRELEASE) {
					var3.onRelease = var8;
				} else
					if (var0 == ScriptOpcodes.CC_SETONMOUSEOVER) {
						var3.onMouseOver = var8;
					} else
						if (var0 == ScriptOpcodes.CC_SETONMOUSELEAVE) {
							var3.onMouseLeave = var8;
						} else
							if (var0 == ScriptOpcodes.CC_SETONDRAG) {
								var3.onDrag = var8;
							} else
								if (var0 == ScriptOpcodes.CC_SETONTARGETLEAVE) {
									var3.onTargetLeave = var8;
								} else
									if (var0 == ScriptOpcodes.CC_SETONVARTRANSMIT) {
										var3.onVarTransmit = var8;
										var3.varTransmitTriggers = var5;
									} else
										if (var0 == ScriptOpcodes.CC_SETONTIMER) {
											var3.onTimer = var8;
										} else
											if (var0 == ScriptOpcodes.CC_SETONOP) {
												var3.onOp = var8;
											} else
												if (var0 == ScriptOpcodes.CC_SETONDRAGCOMPLETE) {
													var3.onDragComplete = var8;
												} else
													if (var0 == ScriptOpcodes.CC_SETONCLICKREPEAT) {
														var3.onClickRepeat = var8;
													} else
														if (var0 == ScriptOpcodes.CC_SETONMOUSEREPEAT) {
															var3.onMouseRepeat = var8;
														} else
															if (var0 == ScriptOpcodes.CC_SETONINVTRANSMIT) {
																var3.onInvTransmit = var8;
																var3.invTransmitTriggers = var5;
															} else
																if (var0 == ScriptOpcodes.CC_SETONSTATTRANSMIT) {
																	...
																	if (var0 == ScriptOpcodes.CC_SETONTARGETENTER) {
																		...
																		if (var0 == ScriptOpcodes.CC_SETONSCROLLWHEEL) {
																			var3.onScroll = var8;
																		} else
																			if (var0 == ScriptOpcodes.CC_SETONCHATTRANSMIT) {
																				var3.onChatTransmit = var8;
																			} else
																				if (var0 == ScriptOpcodes.CC_SETONKEY) {
																					var3.onKey = var8;
																				} else
																					if (var0 == ScriptOpcodes.CC_SETONFRIENDTRANSMIT) {
																						var3.onFriendTransmit = var8;
																					} else
																						if (var0 == ScriptOpcodes.CC_SETONCLANTRANSMIT) {
																							var3.onClanTransmit = var8;
																						} else
																							if (var0 == ScriptOpcodes.CC_SETONMISCTRANSMIT) {
																								var3.onMiscTransmit = var8;
																							} else
																								if (var0 == ScriptOpcodes.CC_SETONDIALOGABORT) {
																									var3.onDialogAbort = var8;
																								} else
																									if (var0 == ScriptOpcodes.CC_SETONSUBCHANGE) {
																										var3.onSubChange = var8;
																									} else
																										if (var0 == ScriptOpcodes.CC_SETONSTOCKTRANSMIT) {
																											...
																											if (var0 == 1426) {
																												...
																												if (var0 == ScriptOpcodes.CC_SETONRESIZE) {
																													...
																													if (var0 == ScriptOpcodes.CC_SETONCLANSETTINGSTRANSMIT) {
																														var3.field3365 = var8;
																													} else
																														if (var0 == ScriptOpcodes.CC_SETONCLANCHANNELTRANSMIT) {
																															var3.field3353 = var8;
																														} else
																															if (var0 == 1430) {
																																var3.field3516 = var8;
	...
	static void load() {
		...
		if (Client.titleLoadingStage == 0) {
			...
			if (Client.titleLoadingStage == 20) {
				...
				if (Client.titleLoadingStage == 30) {
					...
					if (Client.titleLoadingStage != 40) {
						Archive var20;
						Archive var21;
						Archive var22;
								...
								if (Client.titleLoadingStage == 60) {
									...
									if (Client.titleLoadingStage == 70) {
										if (!class140.archive2.isFullyLoaded()) {
											...
											if (!class132.field1588.isFullyLoaded()) {
										...
										if (Client.titleLoadingStage == 80) {
											...
											if (Client.titleLoadingStage == 90) {
												...
												if (Client.titleLoadingStage == 100) {
													...
													if (Client.titleLoadingStage == 110) {
														...
														if (Client.titleLoadingStage == 120) {
															...
															if (Client.titleLoadingStage == 130) {
																...
																if (Client.titleLoadingStage == 140) {
																	...
																	if (Client.titleLoadingStage == 150) {
