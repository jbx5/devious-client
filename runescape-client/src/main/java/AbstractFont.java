...
public abstract class AbstractFont extends Rasterizer2D {
         ...
         for(var7 = 0; var7 < 256; ++var7) {
            if (var7 != 32 && var7 != 160) {
               for(var8 = 0; var8 < 256; ++var8) {
                  if (var8 != 32 && var8 != 160) {
                     this.kerning[var8 + (var7 << 8)] = (byte)method7142(var11, var12, var4, this.advances, var10, var7, var8);
                  }
               }
            }
         }
                  ...
                  if (var7.equals("lt")) {
                     ...
                     if (!var7.equals("gt")) {
                        if (var7.startsWith("img=")) {
                           try {
                              int var8 = GrandExchangeEvent.method6573(var7.substring(4));
            ...
            if (var15 == '<') {
               ...
               if (var15 == '>' && var10 != -1) {
                  ...
                  if (var16.equals("br")) {
                     ...
                     try {
                        int var17 = GrandExchangeEvent.method6573(var16.substring(4));
   ...
   public class451 method7155(class379 var1, int var2, int var3, int var4, int var5, int var6) {
      if (!var1.method7246()) {
         ...
         for(int var7 = 0; var7 < var1.method7247(); ++var7) {
            class377 var8 = var1.method7251(var7);
            if (var6 != -1 && var8.field4378 > var6) {
               return new class451(var8.field4379, var8.field4378);
            }

            char var9 = var8.field4380;
            if (var9 != '\n') {
               if (var1.method7245(var7)) {
                  var9 = '*';
               }
               ...
               if (var9 != '\t') {
                  ...
                  int var10 = var2 + var8.field4379;
                  int var11 = var3 + var8.field4378;
                  ...
                  if (var8.equals("lt")) {
                     ...
                     if (!var8.equals("gt")) {
                        if (var8.startsWith("img=")) {
                           try {
                              var9 = GrandExchangeEvent.method6573(var8.substring(4));
                     ...
                     if (!var11.equals("gt")) {
                        if (var11.startsWith("img=")) {
                           try {
                              ...
                              ++var8;
                              var14 = GrandExchangeEvent.method6573(var11.substring(4));
