		...
		if (var5 != null) {
			...
			if (var11) {
				...
				if (var7) {
					...
					if (var0 == 1) {
						var10 = class503.getPacketBufferNode(ClientPacket.field3129, Client.packetWriter.isaacCipher);
					...
					if (var0 == 2) {
						var10 = class503.getPacketBufferNode(ClientPacket.field3178, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 3) {
						var10 = class503.getPacketBufferNode(ClientPacket.field3096, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 4) {
						var10 = class503.getPacketBufferNode(ClientPacket.field3131, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 5) {
						var10 = class503.getPacketBufferNode(ClientPacket.field3127, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 6) {
						var10 = class503.getPacketBufferNode(ClientPacket.field3100, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 7) {
						var10 = class503.getPacketBufferNode(ClientPacket.field3177, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 8) {
						var10 = class503.getPacketBufferNode(ClientPacket.field3151, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 9) {
						var10 = class503.getPacketBufferNode(ClientPacket.field3119, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 10) {
						var10 = class503.getPacketBufferNode(ClientPacket.field3117, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
