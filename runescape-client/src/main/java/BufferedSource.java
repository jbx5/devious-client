...
public class BufferedSource implements Runnable {
    ...
    @ObfuscatedName("s")
    @ObfuscatedGetter(intValue = -278059203)
    @Export("capacity")
    int capacity;
    ...
    @ObfuscatedName("r")
    @ObfuscatedGetter(intValue = 1313877129)
    @Export("position")
    int position;

    @ObfuscatedName("o")
    @ObfuscatedGetter(intValue = 1487831007)
    @Export("limit")
    int limit;
    ...
    @ObfuscatedName("s")
    @ObfuscatedSignature(descriptor = "(I)I", garbageValue = "-677588890")
    ...
    @ObfuscatedName("e")
    @ObfuscatedSignature(descriptor = "([BIIS)I", garbageValue = "-28937")
    @Export("read")
