...
public class Huffman {
	...
	static int method5646(int var0, int var1) {
		int var2 = var1 - 334; // L: 5277
		if (var2 < 0) { // L: 5278
			var2 = 0;
		} else if (var2 > 100) { // L: 5279
			var2 = 100;
		}

		int var3 = (Client.zoomWidth - Client.zoomHeight) * var2 / 100 + Client.zoomHeight; // L: 5280
		return var0 * var3 / 256; // L: 5281
	}
}
