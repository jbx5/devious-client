...
public class MidiPcmStream extends PcmStream {
	@ObfuscatedName("ix")
	@ObfuscatedGetter(intValue = 1972992415)
	...
	@ObfuscatedName("b")
	@ObfuscatedGetter(intValue = -1989200593)
	int field3069;

	@ObfuscatedName("p")
	@ObfuscatedGetter(intValue = 1925725407)
	int field3075;
	...
	@ObfuscatedName("an")
	@ObfuscatedGetter(intValue = -18186103)
	@Export("track")
	int track;

	@ObfuscatedName("ax")
	@ObfuscatedGetter(intValue = 1268165937)
	@Export("trackLength")
	int trackLength;

	@ObfuscatedName("am")
	@ObfuscatedGetter(longValue = 6776460792524866117L)
	long field3093;

	@ObfuscatedName("az")
	@ObfuscatedGetter(longValue = 7641976143722110143L)
	long field3094;
	...
	@ObfuscatedName("c")
	@ObfuscatedSignature(descriptor = "(II)V", garbageValue = "-906124112")
	...
	@ObfuscatedName("b")
	@ObfuscatedSignature(descriptor = "(I)I", garbageValue = "600611451")
	int method5073() {
		return this.field3069;
	}

	@ObfuscatedName("p")
	@ObfuscatedSignature(descriptor = "(Ljk;Lku;Laa;II)Z", garbageValue = "-256912575")
	...
	@ObfuscatedName("m")
	@ObfuscatedSignature(descriptor = "(I)V", garbageValue = "1865600049")
	@Export("clearAll")
	...
	@ObfuscatedName("t")
	@ObfuscatedSignature(descriptor = "(I)V", garbageValue = "-1487279179")
	@Export("removeAll")
	...
	@ObfuscatedName("r")
	@ObfuscatedSignature(descriptor = "(Ljk;ZI)V", garbageValue = "328855214")
	...
	@ObfuscatedName("d")
	@ObfuscatedSignature(descriptor = "(I)Z", garbageValue = "154735720")
	@Export("isReady")
	...
	@ObfuscatedName("h")
	@ObfuscatedSignature(descriptor = "(III)V", garbageValue = "-1583384688")
	...
	@ObfuscatedName("e")
	@ObfuscatedSignature(descriptor = "(III)V", garbageValue = "-1761005899")
	...
	@ObfuscatedName("a")
	@ObfuscatedSignature(descriptor = "(IIII)V", garbageValue = "-1972733350")
	...
	@ObfuscatedName("u")
	@ObfuscatedSignature(descriptor = "(Ljq;ZI)V", garbageValue = "1432160102")
	...
	@ObfuscatedName("k")
	@ObfuscatedSignature(descriptor = "(IIIB)V", garbageValue = "97")
	...
	@ObfuscatedName("f")
	@ObfuscatedSignature(descriptor = "(IIII)V", garbageValue = "1104599593")
	void method5085(int var1, int var2, int var3) {
	}

	@ObfuscatedName("l")
	@ObfuscatedSignature(descriptor = "(III)V", garbageValue = "-875274554")
	...
	@ObfuscatedName("x")
	@ObfuscatedSignature(descriptor = "(II)V", garbageValue = "1499512267")
	...
	@ObfuscatedName("ax")
	@ObfuscatedSignature(descriptor = "(II)V", garbageValue = "171384389")
	...
	@ObfuscatedName("af")
	@ObfuscatedSignature(descriptor = "(IS)V", garbageValue = "16256")
	...
	@ObfuscatedName("ar")
	@ObfuscatedSignature(descriptor = "(II)V", garbageValue = "2130755368")
	...
	void method5095(int var1, int var2) {
		...
		this.field3086[var1] = ((int) ((2097152.0 * Math.pow(2.0, ((double) (var2)) * 5.4931640625E-4)) + 0.5));
	}

	@ObfuscatedName("al")
	@ObfuscatedSignature(descriptor = "(Ljq;B)I", garbageValue = "-119")
	int method5170(MusicPatchNode var1) {
		...
		if ((var3.field3059 > 0) && ((var3.field3058 > 0) || (this.field3078[var1.field3149] > 0))) {
			...
			double var6 = Math.sin(((double) (var1.field3145 & 511)) * 0.01227184630308513);
			var2 += ((int) (var6 * ((double) (var4))));
		}
		var4 = ((int) (((((double) (var1.rawSound.sampleRate * 256)) * Math.pow(2.0, 3.255208333333333E-4 * ((double) (var2)))) / ((double) (class339.field4058))) + 0.5));
		return var4 < 1 ? 1 : var4;
	}

	@ObfuscatedName("aa")
	@ObfuscatedSignature(descriptor = "(Ljq;I)I", garbageValue = "1173638767")
	int method5097(MusicPatchNode var1) {
		...
		if (var2.field3052 > 0) {
			var3 = ((int) ((((double) (var3)) * Math.pow(0.5, (((double) (var2.field3052)) * 1.953125E-5) * ((double) (var1.field3139)))) + 0.5));
		}
		int var4;
		int var5;
		int var6;
	...
	@ObfuscatedName("as")
	@ObfuscatedSignature(descriptor = "(Ljq;I)I", garbageValue = "1815861721")
	...
	@ObfuscatedName("at")
	@ObfuscatedSignature(descriptor = "(B)V", garbageValue = "100")
	void method5104() {
		int var1 = this.track;
	...
	@ObfuscatedName("ai")
	@ObfuscatedSignature(descriptor = "(Ljq;I)Z", garbageValue = "-1286504674")
	...
	@ObfuscatedName("aq")
	@ObfuscatedSignature(descriptor = "(Ljq;[IIIB)Z", garbageValue = "-28")
	boolean method5106(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if ((var1.field3142 < 0) || ((var1.stream != null) && (!var1.stream.method854()))) {
			...
			if (var5 > 0) {
				var5 -= ((int) ((16.0 * Math.pow(2.0, ((double) (this.field3079[var1.field3149])) * 4.921259842519685E-4)) + 0.5));
				if (var5 < 0) {
					var5 = 0;
				}
				var1.field3138 = var5;
			...
			double var8 = 5.086263020833333E-6 * ((double) (((var1.field3133 - 60) << 8) + ((var1.field3137 * var1.field3138) >> 12)));
			if (var6.field3052 > 0) {
				if (var6.field3057 > 0) {
					var1.field3139 += ((int) ((128.0 * Math.pow(2.0, var8 * ((double) (var6.field3057)))) + 0.5));
				} else {
					var1.field3139 += 128;
				}
			}
			if (var6.field3056 != null) {
				if (var6.field3055 > 0) {
					var1.field3140 += ((int) ((128.0 * Math.pow(2.0, var8 * ((double) (var6.field3055)))) + 0.5));
				} else {
					var1.field3140 += 128;
				}
			...
			if ((((var1.field3142 >= 0) && (var6.field3054 != null)) && ((this.field3081[var1.field3149] & 1) == 0)) && ((var1.field3128 < 0) || (var1 != this.field3088[var1.field3149][var1.field3128]))) {
				if (var6.field3053 > 0) {
					var1.field3142 += ((int) ((128.0 * Math.pow(2.0, var8 * ((double) (var6.field3053)))) + 0.5));
				} else {
					var1.field3142 += 128;
				}
	...
	@ObfuscatedName("b")
	@ObfuscatedSignature(descriptor = "([FIFI)F", garbageValue = "-941170538")
