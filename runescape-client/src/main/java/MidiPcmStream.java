...
public class MidiPcmStream extends PcmStream {
   ...
   int method5294(MusicPatchNode var1) {
      ...
      if (var2.field3181 != null) {
         var4 = var1.field3264;
         var5 = var2.field3181[var1.field3270 * 4 + 1];
         if (var1.field3270 * 4 < var2.field3181.length - 2) {
            var6 = (var2.field3181[var1.field3270 * 4] & 255) << 8;
            var7 = (var2.field3181[var1.field3270 * 4 + 2] & 255) << 8;
            var5 += (var2.field3181[var1.field3270 * 4 + 3] - var5) * (var4 - var6) / (var7 - var6);
         }
   ...
   boolean method5303(MusicPatchNode var1, int[] var2, int var3, int var4) {
      ...
      if (var1.field3275 < 0 || var1.stream != null && !var1.stream.method859()) {
         ...
         if (var6.field3181 != null) {
            ...
            while(var1.field3270 * 4 < var6.field3181.length - 2 && var1.field3264 > (var6.field3181[var1.field3270 * 4 + 2] & 255) << 8) {
               var1.field3270 = var1.field3270 * 4 + 2;
            }

            if (var1.field3270 * 4 == var6.field3181.length - 2 && var6.field3181[var1.field3270 * 4 + 1] == 0) {
               var7 = true;
            }
         }
