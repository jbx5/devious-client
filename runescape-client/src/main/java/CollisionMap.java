...
public class CollisionMap {
    @ObfuscatedName("ao")
    @ObfuscatedGetter(intValue = 655302433)
    @Export("xInset")
    public int xInset;

    @ObfuscatedName("aq")
    @ObfuscatedGetter(intValue = -1220938779)
    @Export("yInset")
    public int yInset;

    @ObfuscatedName("ay")
    @ObfuscatedGetter(intValue = -1760314827)
    @Export("xSize")
    int xSize;

    @ObfuscatedName("ac")
    @ObfuscatedGetter(intValue = -1723006743)
    @Export("ySize")
    int ySize;
    ...
    @ObfuscatedName("c")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "1665588354")
    @Export("clear")
    public void clear() {
    ...
    @ObfuscatedName("l")
    @ObfuscatedSignature(descriptor = "(IIIIZI)V", garbageValue = "2049533735")
    ...
    @ObfuscatedName("s")
    @ObfuscatedSignature(descriptor = "(IIIIZI)V", garbageValue = "-429830438")
    ...
    @ObfuscatedName("e")
    @ObfuscatedSignature(descriptor = "(IIB)V", garbageValue = "-55")
    ...
    @ObfuscatedName("r")
    @ObfuscatedSignature(descriptor = "(III)V", garbageValue = "2074310404")
    ...
    @ObfuscatedName("o")
    @ObfuscatedSignature(descriptor = "(IIIS)V", garbageValue = "9111")
    @Export("setFlag")
    ...
    @ObfuscatedName("i")
    @ObfuscatedSignature(descriptor = "(IIIIZI)V", garbageValue = "-1578864959")
    ...
    @ObfuscatedName("w")
    @ObfuscatedSignature(descriptor = "(IIIIIZB)V", garbageValue = "84")
    ...
    @ObfuscatedName("v")
    @ObfuscatedSignature(descriptor = "(IIIB)V", garbageValue = "46")
    @Export("setFlagOff")
    ...
    @ObfuscatedName("a")
    @ObfuscatedSignature(descriptor = "(III)V", garbageValue = "626666517")
    ...
    @ObfuscatedName("c")
    @ObfuscatedSignature(descriptor = "(I)[Liq;", garbageValue = "1958044668")
