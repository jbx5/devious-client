...
public class CollisionMap {
	...
	@ObfuscatedName("ae")
	@ObfuscatedGetter(intValue = 414195973)
	@Export("xInset")
	public int xInset;

	@ObfuscatedName("aj")
	@ObfuscatedGetter(intValue = 1573477015)
	@Export("yInset")
	public int yInset;

	@ObfuscatedName("am")
	@ObfuscatedGetter(intValue = 288008669)
	@Export("xSize")
	int xSize;

	@ObfuscatedName("an")
	@ObfuscatedGetter(intValue = 1138846055)
	@Export("ySize")
	int ySize;
	...
	@ObfuscatedName("c")
	@ObfuscatedSignature(descriptor = "(S)V", garbageValue = "171")
	@Export("clear")
	public void clear() {
	...
	@ObfuscatedName("v")
	@ObfuscatedSignature(descriptor = "(IIIIZI)V", garbageValue = "740345801")
	...
	@ObfuscatedName("q")
	@ObfuscatedSignature(descriptor = "(IIIIZI)V", garbageValue = "129633396")
	...
	@ObfuscatedName("f")
	@ObfuscatedSignature(descriptor = "(III)V", garbageValue = "-1940880076")
	...
	@ObfuscatedName("j")
	@ObfuscatedSignature(descriptor = "(III)V", garbageValue = "-2021417424")
	...
	@ObfuscatedName("e")
	@ObfuscatedSignature(descriptor = "(IIIB)V", garbageValue = "-124")
	@Export("setFlag")
	...
	@ObfuscatedName("g")
	@ObfuscatedSignature(descriptor = "(IIIIZB)V", garbageValue = "-83")
	...
	@ObfuscatedName("w")
	@ObfuscatedSignature(descriptor = "(IIIIIZI)V", garbageValue = "1140474967")
	...
	@ObfuscatedName("y")
	@ObfuscatedSignature(descriptor = "(IIII)V", garbageValue = "-2090051353")
	@Export("setFlagOff")
	...
	@ObfuscatedName("i")
	@ObfuscatedSignature(descriptor = "(III)V", garbageValue = "-2033602418")
	...
	@ObfuscatedName("hs")
	@ObfuscatedSignature(descriptor = "(I)V", garbageValue = "35579750")
	static final void method3907() {
		for (GraphicsObject var0 = ((GraphicsObject) (Client.graphicsObjects.last())); var0 != null; var0 = ((GraphicsObject) (Client.graphicsObjects.previous()))) {
			if (var0.plane == PacketWriter.Client_plane && !var0.isFinished) {
				if (Client.cycle >= var0.cycleStart) {
					var0.advance(Client.field555);
					if (var0.isFinished) {
						var0.remove();
					} else {
						class356.scene.drawEntity(var0.plane, var0.x, var0.y, var0.z, 60, var0, 0, -1L, false);
					}
				}
			} else {
				var0.remove();
	...
	@ObfuscatedName("kd")
	@ObfuscatedSignature(descriptor = "(III)V", garbageValue = "-122477483")
	static void method3906(int var0, int var1) {
		class229.method4904(class20.tempMenuAction, var0, var1);
		class20.tempMenuAction = null;
	}
}