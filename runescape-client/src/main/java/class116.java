...
public class class116 implements MouseWheel {
	...
	@ObfuscatedName("j")
	@ObfuscatedGetter(intValue = -1981923463)
	final int field1420;

	@ObfuscatedName("w")
	@ObfuscatedGetter(intValue = -135847907)
	final int field1417;

	@ObfuscatedName("n")
	@ObfuscatedGetter(intValue = 249405033)
	final int field1422;
	static 
	{
	...
	@ObfuscatedName("p")
	@ObfuscatedSignature(descriptor = "(B)I", garbageValue = "94")
	int method2669() {
	...
	@ObfuscatedName("ai")
	@ObfuscatedSignature(descriptor = "(Ljava/lang/String;I)I", garbageValue = "-2039612371")
	...
	static void method2662() {
		...
		PacketBufferNode var2 = HitSplatDefinition.getPacketBufferNode(ClientPacket.WINDOW_STATUS, Client.packetWriter.isaacCipher);
