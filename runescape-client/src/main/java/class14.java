...
public class class14 {
	@ObfuscatedName("c")
	@ObfuscatedGetter(intValue = -691857245)
	final int field80;
	...
	@ObfuscatedName("c")
	@ObfuscatedSignature(descriptor = "(II)Ljava/util/concurrent/ThreadPoolExecutor;", garbageValue = "-1684515517")
	...
	@ObfuscatedName("b")
	@ObfuscatedSignature(descriptor = "(Lo;I)Lf;", garbageValue = "-977382928")
	...
	@ObfuscatedName("p")
	@ObfuscatedSignature(descriptor = "(I)V", garbageValue = "1972637620")
	...
	@ObfuscatedName("c")
	@ObfuscatedSignature(descriptor = "(Ldn;FB)F", garbageValue = "1")
		...
		if ((var0 != null) && (var0.method2637() != 0)) {
			if (var1 < ((float) (var0.field1393[0].field1359))) {
				...
				if (var2 == null) {
					...
					if ((0.0 == ((double) (var2.field1352))) && (((double) (var2.field1357)) == 0.0)) {
						var3 = true;
	...
	@ObfuscatedName("s")
	@ObfuscatedSignature(descriptor = "(ZZI)I", garbageValue = "-1522814517")
	...
	@ObfuscatedName("id")
	@ObfuscatedSignature(descriptor = "(I)Z", garbageValue = "724384814")
