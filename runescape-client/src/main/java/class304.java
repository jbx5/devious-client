...
public class class304 {
	...
	static boolean updateExternalPlayer(PacketBuffer var0, int var1) {
		...
		if (var2 == 0) {
			...
			if (Client.players[var1] != null) {
				...
				var9 = var7 >> 14 & 255;
				var10 = var7 & 255;
				var11.pathTraversed[0] = Players.field1370[var1];
				var11.plane = (byte)var8;
				var11.resetPath((var9 << 13) + var3 - class20.baseX * 64, (var10 << 13) + var4 - class19.baseY * 64);
	...
	static void method5860() {
		for (InterfaceParent var0 = (InterfaceParent)Client.interfaceParents.first(); var0 != null; var0 = (InterfaceParent)Client.interfaceParents.next()) {
			int var1 = var0.group;
			if (class33.field184.method6242(var1)) {
				boolean var2 = true;
				Widget[] var3 = class33.field184.field3587[var1];
				...
				if (!var2) {
					var4 = (int)var0.key;
					Widget var5 = class33.field184.method6240(var4);
					if (var5 != null) {
