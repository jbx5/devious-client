	...
	static final void drawMinimap(Widget var0, int var1, int var2, int var3) {
		...
		if (var4 != null) {
			...
			if (Client.minimapState != 2 && Client.minimapState != 5) {
				...
				int var6 = 48 + StudioGame.entity.getX() / 32;
				int var7 = 464 - StudioGame.entity.getY() / 32;
				...
				for (var8 = 0; var8 < Client.mapIconCount; ++var8) {
					var16 = Client.mapIconXs[var8] * 4 + 2 - StudioGame.entity.getX() / 32;
					var10 = Client.mapIconYs[var8] * 4 + 2 - StudioGame.entity.getY() / 32;
				...
				for (var8 = 0; var8 < 104; ++var8) {
					for (var16 = 0; var16 < 104; ++var16) {
						...
						if (var14 != null) {
							var11 = var8 * 4 + 2 - StudioGame.entity.getX() / 32;
							var12 = var16 * 4 + 2 - StudioGame.entity.getY() / 32;
				...
				for (var8 = 0; var8 < class511.topLevelWorldView.npcCount; ++var8) {
					...
					if (var9 != null && var9.isVisible()) {
						...
						if (var18 != null && var18.drawMapDot && var18.isInteractable) {
							var11 = var9.x / 32 - StudioGame.entity.getX() / 32;
							var12 = var9.y / 32 - StudioGame.entity.getY() / 32;
				...
				for (var10 = 0; var10 < var8; ++var10) {
					...
					if (var15 != null && var15.isVisible() && !var15.isHidden && var15 != SoundCache.localPlayer) {
						var12 = var15.x / 32 - StudioGame.entity.getX() / 32;
						int var13 = var15.y / 32 - StudioGame.entity.getY() / 32;
						if (var15.isFriend()) {
				...
				if (Client.hintArrowType != 0 && Client.cycle % 20 < 10) {
					if (Client.hintArrowType == 1 && Client.hintArrowNpcIndex >= 0 && Client.hintArrowNpcIndex < class511.topLevelWorldView.npcs.length) {
						...
						if (var19 != null) {
							var11 = var19.x / 32 - StudioGame.entity.getX() / 32;
							var12 = var19.y / 32 - StudioGame.entity.getY() / 32;
							AsyncRestClient.worldToMinimap(var1, var2, var11, var12, KeyHandler.mapDotSprites[1], var4);
						}
					}

					if (Client.hintArrowType == 2) {
						var10 = Client.hintArrowX * 4 - class511.topLevelWorldView.baseX * 4 + 2 - StudioGame.entity.getX() / 32;
						var11 = Client.hintArrowY * 4 - class511.topLevelWorldView.baseY * 4 + 2 - StudioGame.entity.getY() / 32;
					...
					if (Client.hintArrowType == 10 && Client.hintArrowPlayerIndex >= 0 && Client.hintArrowPlayerIndex < class511.topLevelWorldView.players.length) {
						...
						if (var20 != null) {
							var11 = var20.x / 32 - StudioGame.entity.getX() / 32;
							var12 = var20.y / 32 - StudioGame.entity.getY() / 32;
							AsyncRestClient.worldToMinimap(var1, var2, var11, var12, KeyHandler.mapDotSprites[1], var4);
						}
					}
				}
				...
				if (Client.destinationX != 0) {
					var10 = Client.destinationX * 4 + 2 - StudioGame.entity.getX() / 32;
					var11 = Client.destinationY * 4 + 2 - StudioGame.entity.getY() / 32;
