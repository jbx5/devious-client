...
public class class123 extends class126 {
    ...
    @ObfuscatedName("c")
    @ObfuscatedGetter(intValue = -1571829515)
    int field1505;

    @ObfuscatedName("l")
    @ObfuscatedGetter(intValue = -340443607)
    int field1506;

    @ObfuscatedName("s")
    @ObfuscatedGetter(intValue = -1105823033)
    int field1504;

    @ObfuscatedName("e")
    @ObfuscatedGetter(intValue = 590470605)
    int field1507;
    ...
    @ObfuscatedName("w")
    @ObfuscatedSignature(descriptor = "(B)[I", garbageValue = "113")
    ...
    @ObfuscatedName("ab")
    @ObfuscatedSignature(descriptor = "(II)I", garbageValue = "305738190")
    static int method2719(int var0) {
        return ((int) (Math.pow(2.0, ((double) ((((float) (var0)) / 256.0F) + 7.0F)))));
    }

    @ObfuscatedName("jx")
    @ObfuscatedSignature(descriptor = "(IIIIIIII)V", garbageValue = "-296452038")
    ...
    static void method2721(String var0) {
        ...
        try {
            ...
            if (var0.length() == 0) {
                ...
                long var6 = DirectByteArrayCopier.getServerTime() + 94608000000L;
