...
public final class IsaacCipher {
    @ObfuscatedName("e")
    @ObfuscatedGetter(intValue = -999524803)
    ...
    @ObfuscatedName("i")
    @ObfuscatedGetter(intValue = 277440135)
    @Export("aa")
    int aa;

    @ObfuscatedName("w")
    @ObfuscatedGetter(intValue = -328908591)
    @Export("bb")
    int bb;

    @ObfuscatedName("v")
    @ObfuscatedGetter(intValue = 2004928509)
    @Export("cc")
    int cc;
    ...
    @ObfuscatedName("c")
    @ObfuscatedSignature(descriptor = "(I)I", garbageValue = "1170207183")
    @Export("nextInt")
    ...
    @ObfuscatedName("l")
    @ObfuscatedSignature(descriptor = "(I)I", garbageValue = "180734019")
    ...
    @ObfuscatedName("s")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "429609734")
    ...
    @ObfuscatedName("e")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "312172804")
