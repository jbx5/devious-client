...
public class class9 implements MouseWheel {
   ...
   static final void menuAction(int var0, int var1, int var2, int var3, int var4, String var5, String var6, int var7, int var8) {
      ...
      if (var2 == 1) {
         ...
         var9.packetBuffer.method7969(class300.baseX * 8 + var0);
         ...
         var9.packetBuffer.writeIntME(class358.selectedItemId);
         ...
         var9.packetBuffer.method7771(class300.baseX * 8 + var0);
         ...
         var9.packetBuffer.writeIntME(class300.baseX * 8 + var0);
         var9.packetBuffer.method7771(Message.baseY * 64 + var1);
         var9.packetBuffer.method7762(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
         Client.packetWriter.addNode(var9);
      } else if (var2 == 5) {
         ...
         var9.packetBuffer.method7762(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
         var9.packetBuffer.writeIntME(Message.baseY * 64 + var1);
         var9.packetBuffer.method7969(var3);
         var9.packetBuffer.writeShort(class300.baseX * 8 + var0);
         Client.packetWriter.addNode(var9);
      } else if (var2 == 6) {
         ...
         if (var2 == 7) {
            ...
            if (var2 == 14) {
               ...
               if (var16 != null) {
                  ...
                  var10.packetBuffer.method7771(GrandExchangeOfferOwnWorldComparator.selectedItemSlot);
                  var10.packetBuffer.writeIntME(class358.selectedItemId);
                  var10.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                  var10.packetBuffer.writeIntME(var3);
                                 ...
                                 if (var2 == 1003) {
                                    ...
                                    if (var14 != null) {
                                       ...
                                       if (var18 != null) {
                                          ...
                                          var11.packetBuffer.writeIntME(var18.id);
                                          Client.packetWriter.addNode(var11);
                                       }
                                    }
                                    break label653;
