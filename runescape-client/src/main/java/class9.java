...
public class class9 implements MouseWheel {
   ...
   static final void menuAction(int var0, int var1, int var2, int var3, int var4, String var5, String var6, int var7, int var8) {
      ...
      if (var2 == 1) {
         ...
         var9.packetBuffer.method7969(class300.baseX * 64 + var0);
         var9.packetBuffer.method7771(GrandExchangeOfferOwnWorldComparator.selectedItemSlot);
         var9.packetBuffer.method7771(Message.baseY * 64 + var1);
         var9.packetBuffer.method7762(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
         var9.packetBuffer.method7773(class358.selectedItemId);
         var9.packetBuffer.method7784(GraphicsObject.selectedItemWidget);
         ...
         Client.destinationX = var0;
         Client.destinationY = var1;
         var9 = class433.getPacketBufferNode(ClientPacket.field2934, Client.packetWriter.isaacCipher);
         var9.packetBuffer.method7771(Client.selectedSpellChildIndex);
         var9.packetBuffer.writeShort(Message.baseY * 64 + var1);
         var9.packetBuffer.method7771(class300.baseX * 64 + var0);
         var9.packetBuffer.writeShort(Client.selectedSpellItemId);
         var9.packetBuffer.method7784(class113.selectedSpellWidget);
         var9.packetBuffer.method7969(var3);
         var9.packetBuffer.method7832(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
         Client.packetWriter.addNode(var9);
      } else if (var2 == 3) {
         Client.mouseCrossX = var7;
         Client.mouseCrossY = var8;
         ...
         Client.destinationX = var0;
         Client.destinationY = var1;
         var9 = class433.getPacketBufferNode(ClientPacket.field2942, Client.packetWriter.isaacCipher);
         var9.packetBuffer.writeShort(class300.baseX * 64 + var0);
         var9.packetBuffer.method7771(Message.baseY * 64 + var1);
         ...
         Client.destinationX = var0;
         Client.destinationY = var1;
         var9 = class433.getPacketBufferNode(ClientPacket.field2987, Client.packetWriter.isaacCipher);
         var9.packetBuffer.method7773(var3);
         var9.packetBuffer.method7773(class300.baseX * 64 + var0);
         var9.packetBuffer.method7771(Message.baseY * 64 + var1);
         var9.packetBuffer.method7762(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
         Client.packetWriter.addNode(var9);
      } else if (var2 == 5) {
         ...
         Client.destinationX = var0;
         Client.destinationY = var1;
         var9 = class433.getPacketBufferNode(ClientPacket.field2991, Client.packetWriter.isaacCipher);
         var9.packetBuffer.method7762(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
         var9.packetBuffer.method7773(Message.baseY * 64 + var1);
         var9.packetBuffer.method7969(var3);
         var9.packetBuffer.writeShort(class300.baseX * 64 + var0);
         Client.packetWriter.addNode(var9);
      } else if (var2 == 6) {
         ...
         Client.destinationX = var0;
         Client.destinationY = var1;
         var9 = class433.getPacketBufferNode(ClientPacket.field3004, Client.packetWriter.isaacCipher);
         var9.packetBuffer.writeShort(class300.baseX * 64 + var0);
         ...
         if (var2 == 7) {
            ...
            if (var14 != null) {
               ...
               var10.packetBuffer.method7773(var3);
               var10.packetBuffer.method7762(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
               var10.packetBuffer.method7771(GrandExchangeOfferOwnWorldComparator.selectedItemSlot);
               var10.packetBuffer.method7771(class358.selectedItemId);
               var10.packetBuffer.method7783(GraphicsObject.selectedItemWidget);
            ...
            if (var14 != null) {
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var10 = class433.getPacketBufferNode(ClientPacket.field3013, Client.packetWriter.isaacCipher);
               var10.packetBuffer.method7764(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
               var10.packetBuffer.writeInt(class113.selectedSpellWidget);
               var10.packetBuffer.method7773(Client.selectedSpellItemId);
               var10.packetBuffer.method7969(Client.selectedSpellChildIndex);
            ...
            if (var14 != null) {
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var10 = class433.getPacketBufferNode(ClientPacket.field3009, Client.packetWriter.isaacCipher);
               var10.packetBuffer.method7771(var3);
            ...
            if (var14 != null) {
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var10 = class433.getPacketBufferNode(ClientPacket.field2925, Client.packetWriter.isaacCipher);
               var10.packetBuffer.method7832(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
               var10.packetBuffer.method7771(var3);
               Client.packetWriter.addNode(var10);
            }
         } else if (var2 == 11) {
            ...
            if (var14 != null) {
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var10 = class433.getPacketBufferNode(ClientPacket.field2986, Client.packetWriter.isaacCipher);
               var10.packetBuffer.method7969(var3);
               var10.packetBuffer.method7832(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
               Client.packetWriter.addNode(var10);
            }
         } else if (var2 == 12) {
            ...
            if (var14 != null) {
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var10 = class433.getPacketBufferNode(ClientPacket.field2916, Client.packetWriter.isaacCipher);
               var10.packetBuffer.method7764(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
               var10.packetBuffer.method7771(var3);
               Client.packetWriter.addNode(var10);
            }
            ...
            if (var14 != null) {
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var10 = class433.getPacketBufferNode(ClientPacket.field2921, Client.packetWriter.isaacCipher);
               var10.packetBuffer.writeShort(var3);
               var10.packetBuffer.method7832(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
               Client.packetWriter.addNode(var10);
            }
            ...
            if (var2 == 14) {
               ...
               if (var16 != null) {
                  ...
                  var10.packetBuffer.method7771(GrandExchangeOfferOwnWorldComparator.selectedItemSlot);
                  var10.packetBuffer.method7773(class358.selectedItemId);
                  var10.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                  var10.packetBuffer.method7773(var3);
                  var10.packetBuffer.method7784(GraphicsObject.selectedItemWidget);
                  Client.packetWriter.addNode(var10);
               }
            } else if (var2 == 15) {
               var16 = Client.players[var3];
               if (var16 != null) {
                  ...
                  Client.destinationX = var0;
                  Client.destinationY = var1;
                  var10 = class433.getPacketBufferNode(ClientPacket.field2972, Client.packetWriter.isaacCipher);
                  var10.packetBuffer.writeShort(Client.selectedSpellChildIndex);
                  var10.packetBuffer.method7773(var3);
                  var10.packetBuffer.method7969(Client.selectedSpellItemId);
                  var10.packetBuffer.method7785(class113.selectedSpellWidget);
                  var10.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                  Client.packetWriter.addNode(var10);
               }
            } else if (var2 == 16) {
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var9 = class433.getPacketBufferNode(ClientPacket.field3012, Client.packetWriter.isaacCipher);
               var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
               var9.packetBuffer.method7783(class113.selectedSpellWidget);
               var9.packetBuffer.method7773(Client.selectedSpellChildIndex);
               var9.packetBuffer.writeShort(Client.selectedSpellItemId);
               var9.packetBuffer.method7771(Message.baseY * 64 + var1);
               var9.packetBuffer.method7969(class300.baseX * 64 + var0);
               var9.packetBuffer.method7969(var3);
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var9 = class433.getPacketBufferNode(ClientPacket.field2960, Client.packetWriter.isaacCipher);
               var9.packetBuffer.method7773(var3);
               var9.packetBuffer.writeShort(class300.baseX * 64 + var0);
               var9.packetBuffer.method7773(Message.baseY * 64 + var1);
               var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var9 = class433.getPacketBufferNode(ClientPacket.field2992, Client.packetWriter.isaacCipher);
               var9.packetBuffer.method7771(Message.baseY * 64 + var1);
               var9.packetBuffer.method7773(var3);
               var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
               var9.packetBuffer.method7771(class300.baseX * 64 + var0);
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var9 = class433.getPacketBufferNode(ClientPacket.field2983, Client.packetWriter.isaacCipher);
               var9.packetBuffer.writeShort(var3);
               var9.packetBuffer.method7773(Message.baseY * 64 + var1);
               var9.packetBuffer.method7771(class300.baseX * 64 + var0);
               var9.packetBuffer.method7832(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var9 = class433.getPacketBufferNode(ClientPacket.field3003, Client.packetWriter.isaacCipher);
               var9.packetBuffer.method7762(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
               var9.packetBuffer.method7969(Message.baseY * 64 + var1);
               var9.packetBuffer.method7771(var3);
               var9.packetBuffer.method7969(class300.baseX * 64 + var0);
               Client.packetWriter.addNode(var9);
            } else if (var2 == 22) {
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var9 = class433.getPacketBufferNode(ClientPacket.field2966, Client.packetWriter.isaacCipher);
               var9.packetBuffer.method7969(Message.baseY * 64 + var1);
               var9.packetBuffer.method7773(class300.baseX * 64 + var0);
               var9.packetBuffer.method7764(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
               var9.packetBuffer.method7771(var3);
               ...
               if (var2 == 24) {
                  ...
                  if (var2 == 26) {
                     ...
                     if (var2 == 28) {
                        ...
                        var9.packetBuffer.method7771(var0);
                        var9.packetBuffer.writeInt(GraphicsObject.selectedItemWidget);
                        var9.packetBuffer.method7784(var1);
                        var9.packetBuffer.writeShort(GrandExchangeOfferOwnWorldComparator.selectedItemSlot);
                        var9.packetBuffer.method7771(var4);
                        var9.packetBuffer.writeShort(class358.selectedItemId);
                        Client.packetWriter.addNode(var9);
                        Client.field601 = 0;
                        ...
                        var9.packetBuffer.method7773(var0);
                        var9.packetBuffer.writeInt(class113.selectedSpellWidget);
                        var9.packetBuffer.method7969(Client.selectedSpellChildIndex);
                        var9.packetBuffer.method7969(var4);
                        Client.packetWriter.addNode(var9);
                        Client.field601 = 0;
                        class121.field1488 = FloorUnderlayDefinition.getWidget(var1);
                        Client.field602 = var0;
                        ...
                        var9.packetBuffer.writeInt(var1);
                        var9.packetBuffer.method7969(var0);
                        Client.packetWriter.addNode(var9);
                        Client.field601 = 0;
                        class121.field1488 = FloorUnderlayDefinition.getWidget(var1);
                        Client.field602 = var0;
                        ...
                        var9.packetBuffer.method7771(var0);
                        var9.packetBuffer.method7785(var1);
                        var9.packetBuffer.writeShort(var4);
                        Client.packetWriter.addNode(var9);
                        Client.field601 = 0;
                        class121.field1488 = FloorUnderlayDefinition.getWidget(var1);
                        ...
                        if (var2 == 39) {
                           ...
                           var9.packetBuffer.method7773(var4);
                           var9.packetBuffer.method7783(var1);
                           ...
                           if (var16 != null) {
                              ...
                              Client.destinationX = var0;
                              Client.destinationY = var1;
                              var10 = class433.getPacketBufferNode(ClientPacket.field2947, Client.packetWriter.isaacCipher);
                              var10.packetBuffer.method7764(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                              var10.packetBuffer.method7969(var3);
                              Client.packetWriter.addNode(var10);
                           }
                           ...
                           if (var16 != null) {
                              ...
                              Client.destinationX = var0;
                              Client.destinationY = var1;
                              var10 = class433.getPacketBufferNode(ClientPacket.field2971, Client.packetWriter.isaacCipher);
                              var10.packetBuffer.method7771(var3);
                              var10.packetBuffer.method7764(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                              Client.packetWriter.addNode(var10);
                           }
                           ...
                           if (var16 != null) {
                              ...
                              Client.destinationX = var0;
                              Client.destinationY = var1;
                              var10 = class433.getPacketBufferNode(ClientPacket.field2912, Client.packetWriter.isaacCipher);
                              var10.packetBuffer.method7771(var3);
                              var10.packetBuffer.method7764(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                              Client.packetWriter.addNode(var10);
                           }
                           ...
                           if (var16 != null) {
                              ...
                              Client.destinationX = var0;
                              Client.destinationY = var1;
                              var10 = class433.getPacketBufferNode(ClientPacket.field2961, Client.packetWriter.isaacCipher);
                              var10.packetBuffer.method7969(var3);
                              var10.packetBuffer.method7764(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                              Client.packetWriter.addNode(var10);
                           }
                           ...
                           if (var16 != null) {
                              ...
                              Client.destinationX = var0;
                              Client.destinationY = var1;
                              var10 = class433.getPacketBufferNode(ClientPacket.field2969, Client.packetWriter.isaacCipher);
                              var10.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                              var10.packetBuffer.method7771(var3);
                              Client.packetWriter.addNode(var10);
                           }
                           ...
                           if (var16 != null) {
                              ...
                              Client.destinationX = var0;
                              Client.destinationY = var1;
                              var10 = class433.getPacketBufferNode(ClientPacket.field2946, Client.packetWriter.isaacCipher);
                              var10.packetBuffer.method7762(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                              var10.packetBuffer.method7969(var3);
                              Client.packetWriter.addNode(var10);
                           }
                           ...
                           if (var16 != null) {
                              ...
                              Client.destinationX = var0;
                              Client.destinationY = var1;
                              var10 = class433.getPacketBufferNode(ClientPacket.field3002, Client.packetWriter.isaacCipher);
                              var10.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                              var10.packetBuffer.method7773(var3);
                              Client.packetWriter.addNode(var10);
                           }
                           ...
                           if (var16 != null) {
                              ...
                              Client.destinationX = var0;
                              Client.destinationY = var1;
                              var10 = class433.getPacketBufferNode(ClientPacket.field2911, Client.packetWriter.isaacCipher);
                              var10.packetBuffer.writeShort(var3);
                              var10.packetBuffer.method7762(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                              Client.packetWriter.addNode(var10);
                           }
                           ...
                           label653: {
                              if (var2 != 57) {
                                 if (var2 == 58) {
                                    var17 = class293.getWidgetChild(var1, var0);
                                    if (var17 != null) {
                                       var10 = class433.getPacketBufferNode(ClientPacket.field2965, Client.packetWriter.isaacCipher);
                                       var10.packetBuffer.method7969(var0);
                                       var10.packetBuffer.method7784(var1);
                                       var10.packetBuffer.method7771(Client.selectedSpellItemId);
                                       var10.packetBuffer.method7785(class113.selectedSpellWidget);
                                       var10.packetBuffer.method7773(Client.selectedSpellChildIndex);
                                 ...
                                 if (var2 == 1001) {
                                    ...
                                    Client.destinationX = var0;
                                    Client.destinationY = var1;
                                    var9 = class433.getPacketBufferNode(ClientPacket.field2951, Client.packetWriter.isaacCipher);
                                    var9.packetBuffer.writeShort(Message.baseY * 64 + var1);
                                    var9.packetBuffer.writeShort(class300.baseX * 64 + var0);
                                    var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                                    var9.packetBuffer.writeShort(var3);
                                 ...
                                 if (var2 == 1002) {
                                    ...
                                    Client.mouseCrossColor = 2;
                                    Client.mouseCrossState = 0;
                                    var9 = class433.getPacketBufferNode(ClientPacket.field2930, Client.packetWriter.isaacCipher);
                                    var9.packetBuffer.method7771(var3);
                                    Client.packetWriter.addNode(var9);
                                    break label653;
                                 }
                                 ...
                                 if (var2 == 1003) {
                                    ...
                                    if (var14 != null) {
                                       ...
                                       if (var18 != null) {
                                          var11 = class433.getPacketBufferNode(ClientPacket.field3015, Client.packetWriter.isaacCipher);
                                          var11.packetBuffer.method7773(var18.id);
                                          Client.packetWriter.addNode(var11);
                                       }
                                    }
                                    break label653;
                                 ...
                                 if (var2 == 1004) {
                                    ...
                                    Client.mouseCrossColor = 2;
                                    Client.mouseCrossState = 0;
                                    var9 = class433.getPacketBufferNode(ClientPacket.field2988, Client.packetWriter.isaacCipher);
                                    var9.packetBuffer.method7771(var3);
                                    Client.packetWriter.addNode(var9);
                                    break label653;
                                 }
                                 ...
                                 if (var2 == 1005) {
                                    ...
                                    if (var17 != null && var17.itemQuantities[var0] >= 100000) {
                                       ...
                                       var10 = class433.getPacketBufferNode(ClientPacket.field2988, Client.packetWriter.isaacCipher);
                                       var10.packetBuffer.method7771(var4);
                                       Client.packetWriter.addNode(var10);
                                    }
