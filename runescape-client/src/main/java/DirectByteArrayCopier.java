...
public class DirectByteArrayCopier extends AbstractByteArrayCopier {
	...
	@ObfuscatedName("p")
	@ObfuscatedSignature(descriptor = "(I)[B", garbageValue = "1918796592")
	@Export("get")
	byte[] get() {
	...
	@ObfuscatedName("m")
	@ObfuscatedSignature(descriptor = "([BI)V", garbageValue = "-1795617978")
	@Export("set")
	...
	@ObfuscatedName("ha")
	@ObfuscatedSignature(descriptor = "(Lif;B)V", garbageValue = "14")
	static final void method5328(class253 var0) {
		...
		if (class253.field2911 == var0) {
			...
			if (class253.field2920 == var0) {
				...
				var37 = var1.readUnsignedByteSub();
				var38 = var37 >> 2;
				var39 = var37 & 3;
				...
				if (class253.field2917 == var0) {
					...
					var38 = ((var37 >> 4) & 7) + class17.field90;
					var39 = (var37 & 7) + class167.field1813;
					var40 = var1.readUnsignedShortLE();
					...
					var38 = ((var37 >> 4) & 7) + class17.field90;
					var39 = (var37 & 7) + class167.field1813;
					var40 = var1.readUnsignedShortAddLE();
					...
					if (class253.field2915 == var0) {
						...
						var38 = (var37 >> 4) & 15;
						var39 = var37 & 7;
						var40 = var1.readUnsignedByteAdd();
					...
					if (class253.field2919 == var0) {
						var37 = var1.readUnsignedShort();
						var38 = var1.readUnsignedShortAdd();
						var39 = var1.readUnsignedByteAdd();
