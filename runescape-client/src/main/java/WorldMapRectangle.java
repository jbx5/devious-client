...
public final class WorldMapRectangle {
    ...
    @ObfuscatedName("c")
    @ObfuscatedGetter(intValue = 22629131)
    @Export("width")
    int width;

    @ObfuscatedName("l")
    @ObfuscatedGetter(intValue = 2088042185)
    @Export("height")
    int height;

    @ObfuscatedName("s")
    @ObfuscatedGetter(intValue = 25510589)
    @Export("x")
    int x;

    @ObfuscatedName("e")
    @ObfuscatedGetter(intValue = -81527557)
    @Export("y")
    int y;
    ...
    @ObfuscatedName("l")
    @ObfuscatedSignature(descriptor = "(Lpi;Ljava/lang/String;I)I", garbageValue = "-2092007855")
    ...
    @ObfuscatedName("im")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "-851682909")
