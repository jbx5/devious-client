   ...
   final void doCycleLoggedOut() {
      ...
      try {
         ...
         if (loginState == 5) {
            ...
            var38.packetBuffer.method7687(class268.archive15.hash);
            var38.packetBuffer.method7673(class306.archive7.hash);
            var38.packetBuffer.method7686(SequenceDefinition.archive12.hash);
            var38.packetBuffer.method7673(Friend.archive20.hash);
            var38.packetBuffer.method7687(class299.archive8.hash);
            var38.packetBuffer.writeInt(0);
            var38.packetBuffer.method7673(class271.archive4.hash);
            var38.packetBuffer.method7686(MouseRecorder.archive13.hash);
            var38.packetBuffer.method7686(Decimator.field403.hash);
            var38.packetBuffer.method7687(Renderable.archive2.hash);
            var38.packetBuffer.method7687(FloorUnderlayDefinition.archive11.hash);
            var38.packetBuffer.method7686(PacketBuffer.archive6.hash);
            var38.packetBuffer.writeInt(class340.archive18.hash);
            var38.packetBuffer.writeInt(Varcs.archive14.hash);
            var38.packetBuffer.method7687(KitDefinition.archive10.hash);
            var38.packetBuffer.method7673(class17.field89.hash);
            var38.packetBuffer.method7687(class201.field2366.hash);
            var38.packetBuffer.method7673(ClanChannelMember.archive5.hash);
            var38.packetBuffer.method7673(class120.archive9.hash);
            var38.packetBuffer.method7686(Tile.archive19.hash);
            var38.packetBuffer.method7686(MouseHandler.archive17.hash);
         ...
         if (loginState == 9 && this.field527.method56()) {
            ...
            var29.packetBuffer.method7631(this.field526);
            packetWriter.addNode(var29);
            packetWriter.flush();
            this.field526 = null;
            ApproximateRouteStrategy.method1069(6);
         ...
         if (loginState == 13) {
            ...
            if (loginState != 16) {
               ...
               if (var1.available() >= packetWriter.serverPacketLength) {
                  ...
                  PacketBufferNode var36 = DevicePcmPlayerProvider.getPacketBufferNode(ClientPacket.field2990, packetWriter.isaacCipher);
            ...
            if (isDraggingWidget) {
               ...
               if (draggedOnWidget != null) {
                  ...
                  if (var13 != null) {
                     ...
                     var12.packetBuffer.method7676(clickedWidget.childIndex);
                     var12.packetBuffer.method7686(draggedOnWidget.id);
                     var12.packetBuffer.method7676(clickedWidget.itemId);
