	...
	final boolean method1447(PacketWriter var1) {
		...
		if (var2 == null) { // L: 5947
			...
			try {
				...
				if (ServerPacket.UPDATE_ZONE_FULL_FOLLOWS == var1.serverPacket) { // L: 6021
				...
				if (ServerPacket.field3071 == var1.serverPacket) { // L: 6031
					return this.method1206(var1, 2); // L: 6032
				}

				if (ServerPacket.PROJECTILE_SPAWN == var1.serverPacket) { // L: 6034
				...
				if (ServerPacket.EVENT_WORLDHOP == var1.serverPacket) { // L: 6157
				...
				if (ServerPacket.PLAYER_SPOTANIM == var1.serverPacket) { // L: 6210
					SoundSystem.method813(class264.field3054); // L: 6211
					var1.serverPacket = null; // L: 6212
					return true; // L: 6213
				}

				if (ServerPacket.field3073 == var1.serverPacket) { // L: 6215
				...
				if (ServerPacket.field3169 == var1.serverPacket) { // L: 6225
				...
				if (ServerPacket.VARP_SMALL == var1.serverPacket) { // L: 6231
				...
				GameObject var41;
				byte var79;
				if (ServerPacket.MESSAGE_PRIVATE == var1.serverPacket) { // L: 6242
				...
				if (ServerPacket.IF_SETOBJECT == var1.serverPacket) { // L: 6278
				...
				Widget var71;
				if (ServerPacket.UPDATE_INV_PARTIAL == var1.serverPacket) { // L: 6289
				...
				if (ServerPacket.field3175 == var1.serverPacket) { // L: 6314
				...
				if (ServerPacket.field3139 == var1.serverPacket) { // L: 6339
				...
				if (ServerPacket.NPC_INFO_LARGE_VIEWPORT_1 == var1.serverPacket) { // L: 6352
				...
				if (ServerPacket.field3092 == var1.serverPacket) { // L: 6402
				...
				if (ServerPacket.CAM_LOOKAT == var1.serverPacket) { // L: 6437
				...
				if (ServerPacket.field3071 == var1.serverPacket) { // L: 6451
				...
				boolean var76;
				if (ServerPacket.field3073 == var1.serverPacket) { // L: 6464
				...
				if (ServerPacket.field3073 == var1.serverPacket) { // L: 6475
				...
				if (ServerPacket.field3166 == var1.serverPacket) { // L: 6516
				...
				if (ServerPacket.field3132 == var1.serverPacket) { // L: 6532
				...
				if (ServerPacket.field3151 == var1.serverPacket) { // L: 6550
				...
				if (ServerPacket.GRAPHICSOBJECT_SPAWN == var1.serverPacket) { // L: 6579
					SoundSystem.method813(class264.field3057); // L: 6580
					var1.serverPacket = null; // L: 6581
					return true; // L: 6582
				}

				if (ServerPacket.field3097 == var1.serverPacket) { // L: 6584
				...
				if (ServerPacket.DYNAMICOBJECT_SPAWN == var1.serverPacket) { // L: 6599
				...
				if (ServerPacket.LOGOUT == var1.serverPacket) { // L: 6618
				...
				if (ServerPacket.field3077 == var1.serverPacket) { // L: 6657
				...
				if (ServerPacket.field3075 == var1.serverPacket) { // L: 6675
				...
				if (ServerPacket.field3092 == var1.serverPacket) { // L: 6719
				...
				if (ServerPacket.field3125 == var1.serverPacket) { // L: 6729
				...
				if (ServerPacket.PROJECTILE_SPAWN == var1.serverPacket) { // L: 6772
				...
				if (ServerPacket.IF_MOVESUB == var1.serverPacket) { // L: 6790
				...
				if (ServerPacket.MESSAGE_PRIVATE_ECHO == var1.serverPacket) { // L: 6808
				...
				String var46;
				if (ServerPacket.field3086 == var1.serverPacket) { // L: 6813
				...
				if (ServerPacket.MESSAGE_PRIVATE_ECHO == var1.serverPacket) { // L: 6859
				...
				if (ServerPacket.field3139 == var1.serverPacket) { // L: 6901
				...
				if (ServerPacket.field3086 == var1.serverPacket) { // L: 6912
				...
				if (ServerPacket.field3172 == var1.serverPacket) { // L: 6950
				...
				if (ServerPacket.IF_MOVESUB == var1.serverPacket) { // L: 6975
				...
				if (ServerPacket.field3140 == var1.serverPacket) { // L: 7014
				...
				if (ServerPacket.field3146 == var1.serverPacket) { // L: 7022
				...
				if (ServerPacket.field3151 == var1.serverPacket) { // L: 7029
				...
				if (ServerPacket.MESSAGE_PRIVATE_ECHO == var1.serverPacket) { // L: 7046
					SoundSystem.method813(class264.field3049); // L: 7047
					var1.serverPacket = null; // L: 7048
					return true; // L: 7049
				}

				if (ServerPacket.CAM_RESET == var1.serverPacket && isCameraLocked) { // L: 7051 7052
				...
				if (ServerPacket.RESET_CLIENT_VARCACHE == var1.serverPacket) { // L: 7101
				...
				if (ServerPacket.MESSAGE_PRIVATE_ECHO == var1.serverPacket) { // L: 7148
					SoundSystem.method813(class264.field3055); // L: 7149
					var1.serverPacket = null; // L: 7150
					return true; // L: 7151
				}

				if (ServerPacket.field3092 == var1.serverPacket) { // L: 7153
				...
				if (ServerPacket.MESSAGE_PRIVATE_ECHO == var1.serverPacket) { // L: 7160
				...
				if (ServerPacket.field3121 == var1.serverPacket) { // L: 7269
					class29.field182 = new class393(class150.HitSplatDefinition_cached); // L: 7270
					var1.serverPacket = null; // L: 7271
					return true; // L: 7272
				}

				if (ServerPacket.field3125 == var1.serverPacket) { // L: 7274
				...
				if (ServerPacket.DYNAMICOBJECT_SPAWN == var1.serverPacket) { // L: 7321
				...
				if (ServerPacket.field3140 == var1.serverPacket) { // L: 7335
