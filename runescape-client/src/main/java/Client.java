...
public final class Client extends GameEngine implements Usernamed, OAuthApi, class327 {
	...
	static {
		...
		field559 = class130.base64Encode(class27.method401("com_jagex_auth_desktop_runelite:public"));
	...
	void requestRefreshAccessToken(String var1) throws IOException {
		...
		URL var3 = new URL(ArchiveLoader.field1054 + "shield/oauth/token" + (new HttpQueryParams(var2)).encode());
		HttpHeaders var4 = new HttpHeaders();
		if (this.isRuneLite()) {
			var4.basicAuthentication(field559);
		} else {
			var4.basicAuthentication(BASIC_AUTH_DESKTOP_OSRS);
		}

		var4.header("Host", (new URL(ArchiveLoader.field1054)).getHost());
	...
	void requestOtlToken(String var1) throws IOException {
		URL var2 = new URL(ArchiveLoader.field1054 + "public/v1/games/YCfdbvr2pM1zUYMxJRexZY/play");
	...
	void authenticate(String var1, String var2) throws IOException, JSONException {
		URL var3 = new URL(class31.authServiceBaseUrl + "game-session/v1/tokens");
		...
		try {
					...
					if (field810.method9558()) {
						if (this.containsAccessAndRefreshToken()) {
							try {
								...
								class102.method2651(LoginState.TOKEN_RESPONSE);
							...
							try {
								...
								class102.method2651(LoginState.REFRESHING_TOKEN);
						...
						class102.method2651(LoginState.INIT_MOUSEHANDLER_SOCKET);
					}
				}
			}
			...
			if (LoginState.INIT_MOUSEHANDLER_SOCKET == GraphicsObject.loginState) {
				...
				if (class317.field3469.status == 1) {
					...
					class317.field3469 = null;
					class102.method2651(LoginState.UNMAPPED_20);
				}
			}
			...
			if (GraphicsObject.loginState == LoginState.UNMAPPED_20) {
				...
				packetWriter.flush();
				var2.offset = 0;
				class102.method2651(LoginState.READ_LOGIN_STATUS);
			}
			...
			if (GraphicsObject.loginState == LoginState.READ_LOGIN_STATUS) {
				...
				if (((AbstractSocket)var1).isAvailable(1)) {
					...
					var2.offset = 0;
					class102.method2651(LoginState.READ_RANDOM_VERIFICATION_NUMBER);
				}
			}
			...
			if (GraphicsObject.loginState == LoginState.READ_RANDOM_VERIFICATION_NUMBER) {
				...
				if (var2.offset == 8) {
					...
					class102.method2651(LoginState.WRITE_INITIAL_LOGIN_PACKET);
				}
			}
			...
			if (LoginState.WRITE_INITIAL_LOGIN_PACKET == GraphicsObject.loginState) {
				...
				if (ScriptFrame.field460) {
					var32.packetBuffer.writeIntME(class141.field1669.hash);
					var32.packetBuffer.writeShortLE(UserComparator6.archive6.hash);
					var32.packetBuffer.writeIntME(class93.field1170.hash);
					...
					var32.packetBuffer.writeIntME(UrlRequester.field1452.hash);
					var32.packetBuffer.writeIntIME(class141.field1669.hash);
					var32.packetBuffer.writeIntIME(GraphicsObject.field883.hash);
					var32.packetBuffer.writeIntME(SceneTilePaint.field2883.hash);
					var32.packetBuffer.writeShortLE(LoginState.archive13.hash);
					var32.packetBuffer.writeIntME(0);
					var32.packetBuffer.writeIntME(class17.field75.hash);
					var32.packetBuffer.writeInt(SpriteMask.archive10.hash);
					var32.packetBuffer.writeShortLE(class107.field1377.hash);
					var32.packetBuffer.writeInt(class470.field4874.hash);
					var32.packetBuffer.writeShortLE(GameEngine.archive8.hash);
					...
					var32.packetBuffer.writeShortLE(class73.archive9.hash);
				...
				class102.method2651(LoginState.READ_CLIENT_INFO_STATUS);
			}
			...
			if (GraphicsObject.loginState == LoginState.READ_CLIENT_INFO_STATUS && ((AbstractSocket)var1).available() > 0) {
				...
				if (var13 == 21 && gameState == 20) {
					class102.method2651(LoginState.READ_PROFILE_TRANSFER_TIME);
				} else if (var13 == 2) {
					if (ScriptFrame.field460) {
						class102.method2651(LoginState.UNMAPPED_21);
					} else {
						class102.method2651(LoginState.UNMAPPED);
					}
				} else if (var13 == 15 && gameState == 40) {
					packetWriter.serverPacketLength = -1;
					class102.method2651(LoginState.UNMAPPED_19);
				} else if (var13 == 64) {
					class102.method2651(LoginState.READ_STATE_11_PACKET_SIZE);
				} else if (var13 == 23 && field667 < 1) {
					++field667;
					class102.method2651(LoginState.SHUTDOWN_PREVIOUS_CONNECTION);
				} else if (var13 == 29) {
					class102.method2651(LoginState.UNMAPPED_17);
				} else {
					if (var13 != 69) {
						class28.getLoginError(var13);
						return;
					...
					class102.method2651(LoginState.READ_DIGEST_PARSER_PACKET_SIZE);
				}
			}
			...
			if (GraphicsObject.loginState == LoginState.READ_DIGEST_PARSER_PACKET_SIZE && ((AbstractSocket)var1).available() >= 2) {
				...
				class102.method2651(LoginState.SUBMIT_DIGEST_PARSER_TASK);
			}
			...
			if (LoginState.SUBMIT_DIGEST_PARSER_TASK == GraphicsObject.loginState && ((AbstractSocket)var1).available() >= class127.field1520) {
				...
				try {
					...
					class102.method2651(LoginState.WRITE_DIGEST_PARSER_RESULT);
			...
			if (GraphicsObject.loginState == LoginState.READ_STATE_11_PACKET_SIZE && ((AbstractSocket)var1).available() > 0) {
				...
				class102.method2651(LoginState.UNMAPPED_11);
			}
			...
			if (GraphicsObject.loginState == LoginState.READ_PROFILE_TRANSFER_TIME && ((AbstractSocket)var1).available() > 0) {
				...
				class102.method2651(LoginState.PROFILE_TRANSFER);
			}
			...
			if (LoginState.PROFILE_TRANSFER == GraphicsObject.loginState) {
				...
				var28.packetBuffer.writeIntME(SoundCache.field308.hash);
				...
				var28.packetBuffer.writeShortLE(PlayerType.field4332.hash);
				var28.packetBuffer.writeShortLE(GrandExchangeOfferOwnWorldComparator.archive4.hash);
				var28.packetBuffer.writeIntME(class153.field1726.hash);
				var28.packetBuffer.writeShortLE(class73.archive9.hash);
				var28.packetBuffer.writeIntME(0);
				packetWriter.addNode(var28);
				packetWriter.flush();
				class102.method2651(LoginState.UNMAPPED);
			} else {
				if (LoginState.UNMAPPED == GraphicsObject.loginState && ((AbstractSocket)var1).available() >= 1) {
					...
					class102.method2651(LoginState.READ_ACCOUNT_INFO);
				}
				...
				if (GraphicsObject.loginState == LoginState.READ_ACCOUNT_INFO && ((AbstractSocket)var1).available() >= UrlRequester.field1453) {
					...
					class102.method2651(LoginState.SET_SERVER_PROTOCOL);
				}
				...
				if (GraphicsObject.loginState == LoginState.SET_SERVER_PROTOCOL && ((AbstractSocket)var1).available() >= packetWriter.serverPacketLength) {
					...
					class102.method2651(LoginState.UPDATE_PLAYER_AND_LOAD_REGIONS);
				}
				...
				if (GraphicsObject.loginState == LoginState.UPDATE_PLAYER_AND_LOAD_REGIONS) {
					...
					if (GraphicsObject.loginState == LoginState.UNMAPPED_17 && ((AbstractSocket)var1).available() >= 2) {
						...
						class102.method2651(LoginState.UNMAPPED_18);
					}
					...
					if (GraphicsObject.loginState != LoginState.UNMAPPED_19) {
						...
						if (((AbstractSocket)var1).available() >= packetWriter.serverPacketLength) {
							...
							if (packetWriter != null && packetWriter.isaacCipher != null) {
								PacketBufferNode var39 = FadeInTask.getPacketBufferNode(ClientPacket.field3278, packetWriter.isaacCipher);
			...
			if (gameState == 30) {
				while (true) {
					...
					if (!var32) {
						...
						int var15;
						if (timer.field4696) {
							var14 = FadeInTask.getPacketBufferNode(ClientPacket.field3215, packetWriter.isaacCipher);
						...
						if (MouseHandler.MouseHandler_lastButton == 1 || !class412.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) {
							...
							var5 = (int)var16;
							var18 = FadeInTask.getPacketBufferNode(ClientPacket.field3234, packetWriter.isaacCipher);
						...
						if (indexCheck.field2431 > 0) {
							var14 = FadeInTask.getPacketBufferNode(ClientPacket.field3261, packetWriter.isaacCipher);
							...
							for (var5 = 0; var5 < indexCheck.field2431; ++var5) {
								...
								var14.packetBuffer.writeByteNeg(indexCheck.field2432[var5]);
							}
						...
						if (field640 && field610 <= 0) {
							field610 = 20;
							field640 = false;
							var14 = FadeInTask.getPacketBufferNode(ClientPacket.field3243, packetWriter.isaacCipher);
						...
						if (WorldMapRenderer.hasFocus && !hadFocus) {
							hadFocus = true;
							var14 = FadeInTask.getPacketBufferNode(ClientPacket.field3254, packetWriter.isaacCipher);
															...
															while (true) {
																...
																if (var46 == null) {
																	...
																	if (Scene.shouldSendWalk()) {
																		...
																		var18 = FadeInTask.getPacketBufferNode(ClientPacket.field3284, packetWriter.isaacCipher);
																		...
																		var18.packetBuffer.writeShortAdd(DevicePcmPlayerProvider.baseY * 64 + var5);
																		packetWriter.addNode(var18);
																		Scene.method4748();
																	...
																	if (var4 > 15000 && var5 > 15000) {
																		...
																		var29 = FadeInTask.getPacketBufferNode(ClientPacket.field3219, packetWriter.isaacCipher);
																	...
																	if (packetWriter.pendingWrites > 50) {
																		var29 = FadeInTask.getPacketBufferNode(ClientPacket.field3203, packetWriter.isaacCipher);
																		packetWriter.addNode(var29);
																	}
					...
					var33 = FadeInTask.getPacketBufferNode(ClientPacket.field3276, packetWriter.isaacCipher);
					var33.packetBuffer.writeByte(0);
					var3 = var33.packetBuffer.offset;
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field3372 == var1.serverPacket) {
					var20 = var3.method9462();
					var5 = var3.readUnsignedIntIME();
					short var70 = (short)var3.method9309();
				...
				if (ServerPacket.field3376 == var1.serverPacket) {
					var13 = var3.readUnsignedByteNeg();
					var9 = var3.method9298();
					var10 = var9 >> 2;
					var62 = var9 & 3;
				...
				if (ServerPacket.field3377 == var1.serverPacket) {
					...
					var13 = var3.method9298() * 4;
					var62 = var3.readUnsignedIntLE();
				...
				if (ServerPacket.field3430 == var1.serverPacket) {
					...
					if (hintArrowType >= 2 && hintArrowType <= 6) {
						...
						field534 = var3.readUnsignedByte() * 2;
					}
				...
				if (ServerPacket.field3374 == var1.serverPacket) {
					rebootTimer = var3.readUnsignedByteAdd() * 30;
					field722 = cycleCntr;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3331 == var1.serverPacket) {
					...
					class332.field3602 = var3.method9462();
					field587 = var3.readUnsignedByteSub();
				...
				if (ServerPacket.field3353 == var1.serverPacket) {
					...
					var65 = var3.readUnsignedByteNeg();
					var9 = var64 + var7;
					var10 = var61 + var22;
					if (var7 >= 0 && var22 >= 0 && var7 < 104 && var22 < 104 && var9 >= 0 && var10 >= 0 && var9 < 104 && var10 < 104 && var65 != 65535) {
						var7 = var7 * 128 + 64;
				...
				if (ServerPacket.field3352 == var1.serverPacket) {
					...
					var62 = var3.readUnsignedByteNeg();
				...
				if (ServerPacket.field3440 == var1.serverPacket) {
					class170.method3431();
					var20 = var3.method9298();
					var5 = var3.method9298();
				...
				if (ServerPacket.field3333 == var1.serverPacket) {
					...
					PacketBufferNode var74 = FadeInTask.getPacketBufferNode(ClientPacket.field3213, packetWriter.isaacCipher);
					var74.packetBuffer.writeByteNeg(GameEngine.fps);
					var74.packetBuffer.writeByteNeg(var6);
					var74.packetBuffer.writeInt(var20);
					var74.packetBuffer.writeShortLE(var5);
				...
				if (ServerPacket.field3360 == var1.serverPacket) {
					var20 = var3.readInt();
					if (var20 != hintArrowHeight) {
						hintArrowHeight = var20;
				...
				if (ServerPacket.field3340 == var1.serverPacket) {
					...
					ModelData0.field2905 = var3.method9298();
			...
			if (MouseHandler.MouseHandler_currentButton == 0) {
				if (isDraggingWidget) {
					...
					if (draggedOnWidget != null) {
						...
						if (var14 != null) {
							PacketBufferNode var12 = FadeInTask.getPacketBufferNode(ClientPacket.field3271, packetWriter.isaacCipher);
							...
							var12.packetBuffer.writeIntLE(draggedOnWidget.itemId);
				...
				for (int var1 = 0; var1 <= 28; ++var1) {
					...
					if (var2 != null) {
						...
						case 21:
							...
							break;
						case 22:
							class31.authServiceBaseUrl = var2;
							break;
						case 25:
