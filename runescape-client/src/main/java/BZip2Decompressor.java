...
public final class BZip2Decompressor {
	...
	public static int BZip2Decompressor_decompress(byte[] var0, int var1, byte[] var2, int var3, int var4) {
		synchronized(BZip2Decompressor_state) {
			...
			BZip2Decompressor.BZip2Decompressor_state.field4489 = 0;
	...
	@ObfuscatedName("b")
	@ObfuscatedSignature(descriptor = "(Lpk;)V")
	...
	@ObfuscatedName("m")
	@ObfuscatedSignature(descriptor = "(Lpk;)B")
	...
	@ObfuscatedName("s")
	@ObfuscatedSignature(descriptor = "(ILpk;)I")
