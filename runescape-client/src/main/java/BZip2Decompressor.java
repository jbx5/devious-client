...
public final class BZip2Decompressor {
   ...
   public static int BZip2Decompressor_decompress(byte[] var0, int var1, byte[] var2, int var3, int var4) {
      synchronized(BZip2Decompressor_state) {
         ...
         BZip2Decompressor_state.field4921 = 0;
   ...
   static void method8897(BZip2State var0) {
      ...
      int var13 = var0.field4921;
      var0.field4921 += var10 - var10;
      if (var0.field4921 < var13) {
      }
            ...
            while(true) {
               ...
               while(var45 != var42) {
                  if (var45 != 0 && var45 != 1) {
                     ...
                     class158.BZip2Decompressor_block[var46] = var0.seqToUnseq[var1 & 255] & 255;
                     ++var46;
                     if (var44 == 0) {
                        ++var43;
                        var44 = 50;
                     ...
                     for(var10000[var1 & 255] += var47; var47 > 0; --var47) {
                        class158.BZip2Decompressor_block[var46] = var1 & 255;
                        ++var46;
                     }
                  }
               }
               ...
               for(var36 = 0; var36 < var46; ++var36) {
                  ...
                  var10000 = class158.BZip2Decompressor_block;
                  int var10001 = var0.cftab[var1 & 255];
                  var10000[var10001] |= var36 << 8;
                  var10002 = var0.cftab[var1 & 255]++;
               }

               var0.field4928 = class158.BZip2Decompressor_block[var0.originalPointer] >> 8;
               var0.nblocks_used = 0;
               var0.field4928 = class158.BZip2Decompressor_block[var0.field4928];
               var0.su_ch2 = (byte)(var0.field4928 & 255);
               var0.field4928 >>= 8;
               ++var0.nblocks_used;
               var0.field4946 = var46;
               method8897(var0);
               if (var0.field4946 + 1 == var0.nblocks_used && var0.su_rNToGo == 0) {
                  var26 = true;
                  break;
               }
