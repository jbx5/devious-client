...
public class DevicePcmPlayerProvider implements class47 {
	...
	@ObfuscatedName("c")
	@ObfuscatedSignature(descriptor = "(I)Lar;", garbageValue = "826234570")
	@Export("player")
	...
	@ObfuscatedName("b")
	@ObfuscatedSignature(descriptor = "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;B)V", garbageValue = "114")
	...
	@ObfuscatedName("s")
	@ObfuscatedSignature(descriptor = "(II)Z", garbageValue = "30675574")
	public static boolean method398(int var0) {
		return (var0 >= 0) && (var0 < 112) ? KeyHandler.KeyHandler_pressedKeys[var0] : false;
	}

	@ObfuscatedName("he")
	@ObfuscatedSignature(descriptor = "(ZLpj;I)V", garbageValue = "147077041")
	@Export("loadRegions")
	...
	@ObfuscatedName("hb")
	@ObfuscatedSignature(descriptor = "(IIIIIIII)V", garbageValue = "-149129568")
