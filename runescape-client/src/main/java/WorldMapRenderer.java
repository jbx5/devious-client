		...
		if (var4 != null) {
			...
			if (Client.minimapState != 2 && Client.minimapState != 5) {
				...
				for (var8 = 0; var8 < 104; ++var8) {
					for (var16 = 0; var16 < 104; ++var16) {
						...
						if (var14 != null) {
							...
							GameEngine.drawSpriteOnMinimap(var1, var2, var11, var12, MusicPatchNode2.field3389[0], var4);
						}
					}
				}
				...
				for (var8 = 0; var8 < Client.npcCount; ++var8) {
					...
					if (var9 != null && var9.isVisible()) {
						...
						if (var18 != null && var18.drawMapDot && var18.isInteractable) {
							...
							GameEngine.drawSpriteOnMinimap(var1, var2, var11, var12, MusicPatchNode2.field3389[1], var4);
						}
					}
				}
				...
				for (var10 = 0; var10 < var8; ++var10) {
					...
					if (var15 != null && var15.isVisible() && !var15.isHidden && var15 != class136.localPlayer) {
						...
						if (var15.isFriend()) {
							...
							GameEngine.drawSpriteOnMinimap(var1, var2, var12, var13, MusicPatchNode2.field3389[2], var4);
						}
					}
				}
				...
				if (Client.hintArrowType != 0 && Client.cycle % 20 < 10) {
					if (Client.hintArrowType == 1 && Client.hintArrowNpcIndex >= 0 && Client.hintArrowNpcIndex < Client.npcs.length) {
						...
						if (var19 != null) {
							...
							class158.worldToMinimap(var1, var2, var11, var12, DynamicObject.mapDotSprites[1], var4);
						}
					}
					...
					if (Client.hintArrowType == 2) {
						...
						class158.worldToMinimap(var1, var2, var10, var11, DynamicObject.mapDotSprites[1], var4);
					}
				...
				if (Client.destinationX != 0) {
					...
					GameEngine.drawSpriteOnMinimap(var1, var2, var10, var11, DynamicObject.mapDotSprites[0], var4);
				}
