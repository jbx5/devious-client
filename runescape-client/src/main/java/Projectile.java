	...
	static int method1976(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.MES) {
			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				PacketBufferNode var13 = WorldMapSprite.getPacketBufferNode(ClientPacket.RESUME_P_COUNTDIALOG, Client.packetWriter.isaacCipher);
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					var7 = Interpreter.Interpreter_stringStack[--class122.Interpreter_stringStackSize];
					var11 = WorldMapSprite.getPacketBufferNode(ClientPacket.RESUME_P_NAMEDIALOG, Client.packetWriter.isaacCipher);
					...
					var7 = Interpreter.Interpreter_stringStack[--class122.Interpreter_stringStackSize];
					var11 = WorldMapSprite.getPacketBufferNode(ClientPacket.RESUME_P_STRINGDIALOG, Client.packetWriter.isaacCipher);
					var11.packetBuffer.writeByte(var7.length() + 1);
					var11.packetBuffer.writeStringCp1252NullTerminated(var7);
					Client.packetWriter.addNode(var11);
					return 1;
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						var10 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
						var11 = WorldMapSprite.getPacketBufferNode(ClientPacket.RESUME_P_OBJDIALOG, Client.packetWriter.isaacCipher);
						...
						Interpreter.Interpreter_intStack[(++Interpreter.Interpreter_intStackSize) - 1] = (User.getTapToDrop()) ? 1 : 0;
						return 1;
					} else if (var0 == 3129) {
						Interpreter.Interpreter_intStackSize -= 2;
						...
						Client.field668 = 3;
						Client.field628 = (var2) ? (WorldMapID.scriptDotWidget.id * 1389111653) * 785571949 : (Interpreter.scriptActiveWidget.id * 1389111653) * 785571949;
						return 1;
					} else {
						boolean var3;
