...
public final class Projectile extends Renderable {
	...
	@ObfuscatedName("c")
	@ObfuscatedGetter(intValue = 1101813917)
	@Export("id")
	int id;

	@ObfuscatedName("b")
	@ObfuscatedGetter(intValue = -140525003)
	@Export("plane")
	int plane;

	@ObfuscatedName("p")
	@ObfuscatedGetter(intValue = 636428157)
	@Export("sourceX")
	int sourceX;

	@ObfuscatedName("m")
	@ObfuscatedGetter(intValue = 1985391403)
	@Export("sourceY")
	int sourceY;

	@ObfuscatedName("t")
	@ObfuscatedGetter(intValue = -376580603)
	@Export("sourceZ")
	int sourceZ;

	@ObfuscatedName("s")
	@ObfuscatedGetter(intValue = 1994096823)
	@Export("endHeight")
	int endHeight;

	@ObfuscatedName("j")
	@ObfuscatedGetter(intValue = 1387673175)
	@Export("cycleStart")
	int cycleStart;

	@ObfuscatedName("w")
	@ObfuscatedGetter(intValue = 853821675)
	@Export("cycleEnd")
	int cycleEnd;

	@ObfuscatedName("n")
	@ObfuscatedGetter(intValue = 947987743)
	@Export("slope")
	int slope;

	@ObfuscatedName("r")
	@ObfuscatedGetter(intValue = -175033475)
	@Export("startHeight")
	int startHeight;

	@ObfuscatedName("o")
	@ObfuscatedGetter(intValue = 1305386011)
	@Export("targetIndex")
	int targetIndex;
	...
	@ObfuscatedName("l")
	@ObfuscatedGetter(intValue = -38655435)
	@Export("yaw")
	int yaw;

	@ObfuscatedName("q")
	@ObfuscatedGetter(intValue = -1967440557)
	@Export("pitch")
	int pitch;
	...
	@ObfuscatedName("z")
	@ObfuscatedGetter(intValue = 1747879531)
	@Export("frame")
	int frame;

	@ObfuscatedName("i")
	@ObfuscatedGetter(intValue = -43602097)
	@Export("frameCycle")
	int frameCycle;
	...
	@ObfuscatedName("c")
	@ObfuscatedSignature(descriptor = "(IIIII)V", garbageValue = "1140642232")
	...
	@ObfuscatedName("p")
	@ObfuscatedSignature(descriptor = "(II)V", garbageValue = "-1621806567")
	@Export("advance")
	...
	@ObfuscatedName("b")
	@ObfuscatedSignature(descriptor = "([Ljava/lang/String;[SIIB)V", garbageValue = "60")
	...
	@ObfuscatedName("t")
	@ObfuscatedSignature(descriptor = "(I)Z", garbageValue = "1237382938")
	public static boolean method2008() {
		return class260.musicPlayerStatus != 0 ? true : class260.midiPcmStream.isReady();
	}

	@ObfuscatedName("f")
	@ObfuscatedSignature(descriptor = "(ILbn;ZI)I", garbageValue = "-674197725")
