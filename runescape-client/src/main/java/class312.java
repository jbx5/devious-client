...
public class class312 {
	...
	@ObfuscatedName("t")
	@ObfuscatedGetter(intValue = -895131131)
	int field3911;
	...
	public class312() {
		...
		for (byte var3 = 12; var1 < 16; var2 -= var3) {
			var4 = class338.method6256(((double) (((float) (var2)) / 360.0F)), 0.9998999834060669, ((double) (((((float) (var1)) * 0.425F) / 16.0F) + 0.075F)));
		...
		for (int var6 = var2 / 6; var1 < class111.field1348.length; var2 -= var6) {
			var4 = var1 * 2;
			for (int var5 = class338.method6256(((double) (((float) (var2)) / 360.0F)), 0.9998999834060669, 0.5); (var1 < var4) && (var1 < class111.field1348.length); ++var1) {
	...
	@ObfuscatedName("b")
	@ObfuscatedSignature(descriptor = "(II)Lpl;", garbageValue = "-904544036")
	...
	@ObfuscatedName("t")
	@ObfuscatedSignature(descriptor = "(IILpl;FB)V", garbageValue = "-56")
	...
	@ObfuscatedName("s")
	@ObfuscatedSignature(descriptor = "(Lpl;Lpl;Lme;I)V", garbageValue = "-1046616793")
	...
	@ObfuscatedName("at")
	@ObfuscatedSignature(descriptor = "(ILbn;ZI)I", garbageValue = "586952329")
	...
	@ObfuscatedName("gf")
	@ObfuscatedSignature(descriptor = "(Ljm;IIS)V", garbageValue = "-25379")
