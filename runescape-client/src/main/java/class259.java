   ...
   static void readPlayerUpdate(PacketBuffer var0, int var1) {
      ...
      if (var3 == 0) {
         if (var2) {
            ...
            Players.Players_regions[var1] = (var4.plane << 28) + (class300.baseX * 64 + var4.pathX[0] >> 13 << 14) + (Message.baseY * 64 + var4.pathY[0] >> 13);
            if (var4.field1164 != -1) {
         ...
         if (var3 == 1) {
            ...
            if (var5 == 0) {
               ...
               var8 = var6 >> 14 & 16383;
               var9 = var6 & 16383;
               var10 = (class300.baseX * 64 + var8 + var4.pathX[0] & 16383) - class300.baseX * 64;
