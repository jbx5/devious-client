...
public final class WorldMapManager {
	...
	@ObfuscatedName("v")
	@ObfuscatedGetter(intValue = 656497005)
	@Export("tileX")
	int tileX;

	@ObfuscatedName("d")
	@ObfuscatedGetter(intValue = 742928347)
	@Export("tileY")
	int tileY;

	@ObfuscatedName("h")
	@ObfuscatedGetter(intValue = 513652849)
	@Export("tileWidth")
	int tileWidth;

	@ObfuscatedName("g")
	@ObfuscatedGetter(intValue = -952993593)
	@Export("tileHeight")
	int tileHeight;

	@ObfuscatedName("e")
	@ObfuscatedGetter(intValue = 177187637)
	@Export("pixelsPerTile")
	public int pixelsPerTile;

	@ObfuscatedSignature(descriptor = "([Lpa;Ljava/util/HashMap;Lku;Lku;)V")
	...
	@ObfuscatedName("c")
	@ObfuscatedSignature(descriptor = "(Lku;Ljava/lang/String;ZI)V", garbageValue = "-1533871384")
	@Export("load")
	...
	@ObfuscatedName("b")
	@ObfuscatedSignature(descriptor = "(I)V", garbageValue = "1414126757")
	@Export("clearIcons")
	...
	@ObfuscatedName("p")
	@ObfuscatedSignature(descriptor = "(IIIIIIIII)V", garbageValue = "-29177073")
	@Export("drawTiles")
	public final void drawTiles(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		for (int var21 = var13.x; var21 < (var13.x + var13.width); ++var21) {
			for (int var22 = var13.y; var22 < (var13.height + var13.y); ++var22) {
				this.regions[var21][var22].method4492(var5 + ((((this.regions[var21][var22].regionX * 64) - var19) * var18) / 64), var8 - (((((this.regions[var21][var22].regionY * 64) - var20) + 64) * var18) / 64), var18);
			}
		}
	}

	@ObfuscatedName("m")
	@ObfuscatedSignature(descriptor = "(IIIIIIIILjava/util/HashSet;Ljava/util/HashSet;IIZI)V", garbageValue = "-69482236")
	@Export("drawElements")
	public final void drawElements(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, HashSet var9, HashSet var10, int var11, int var12, boolean var13) {
		...
		for (var19 = var14.x; var19 < (var14.width + var14.x); ++var19) {
			for (var20 = var14.y; var20 < (var14.height + var14.y); ++var20) {
				...
				this.regions[var19][var20].method4588(var5 + ((((this.regions[var19][var20].regionX * 64) - var17) * var16) / 64), var8 - (((((this.regions[var19][var20].regionY * 64) - var18) + 64) * var16) / 64), var16, var9);
			}
		}
	...
	@ObfuscatedName("t")
	@ObfuscatedSignature(descriptor = "(IIIILjava/util/HashSet;IIB)V", garbageValue = "-122")
	@Export("drawOverview")
	...
	@ObfuscatedName("s")
	@ObfuscatedSignature(descriptor = "(IIIIIIIIIII)Ljava/util/List;", garbageValue = "546478193")
		...
		if (!this.loaded) {
			...
			for (int var17 = var12.x; var17 < (var12.x + var12.width); ++var17) {
				for (int var18 = var12.y; var18 < (var12.y + var12.height); ++var18) {
					List var19 = this.regions[var17][var18].method4522(var5 + ((((this.regions[var17][var18].regionX * 64) - var15) * var14) / 64), (var8 + var6) - (((((this.regions[var17][var18].regionY * 64) - var16) + 64) * var14) / 64), var14, var9, var10);
					if (!var19.isEmpty()) {
						var11.addAll(var19);
					}
				}
	...
	@ObfuscatedName("j")
	@ObfuscatedSignature(descriptor = "(IIIII)Lhs;", garbageValue = "2077706460")
	...
	@ObfuscatedName("n")
	@ObfuscatedSignature(descriptor = "(I)Ljava/util/HashMap;", garbageValue = "-1251505644")
	@Export("buildIcons")
	...
	@ObfuscatedName("r")
	@ObfuscatedSignature(descriptor = "(I)V", garbageValue = "-1332406635")
	@Export("buildIcons0")
	void buildIcons0() {
		if (this.icons == null) {
	...
	@ObfuscatedName("o")
	@ObfuscatedSignature(descriptor = "(IIB)F", garbageValue = "-25")
