...
public final class WorldMapManager {
    ...
    @ObfuscatedName("u")
    @ObfuscatedGetter(intValue = 107114539)
    @Export("tileX")
    int tileX;

    @ObfuscatedName("h")
    @ObfuscatedGetter(intValue = -866054195)
    @Export("tileY")
    int tileY;

    @ObfuscatedName("q")
    @ObfuscatedGetter(intValue = -2043471341)
    @Export("tileWidth")
    int tileWidth;

    @ObfuscatedName("x")
    @ObfuscatedGetter(intValue = -1974150815)
    @Export("tileHeight")
    int tileHeight;

    @ObfuscatedName("p")
    @ObfuscatedGetter(intValue = -1411681)
    @Export("pixelsPerTile")
    public int pixelsPerTile;

    @ObfuscatedSignature(descriptor = "([Lpg;Ljava/util/HashMap;Lkq;Lkq;)V")
    ...
    @ObfuscatedName("c")
    @ObfuscatedSignature(descriptor = "(Lkq;Ljava/lang/String;ZB)V", garbageValue = "1")
    @Export("load")
    ...
    @ObfuscatedName("l")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "-417241772")
    @Export("clearIcons")
    ...
    @ObfuscatedName("s")
    @ObfuscatedSignature(descriptor = "(IIIIIIIII)V", garbageValue = "1948663380")
    @Export("drawTiles")
    public final void drawTiles(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
        ...
        for (int var21 = var13.x; var21 < (var13.x + var13.width); ++var21) {
            for (int var22 = var13.y; var22 < (var13.y + var13.height); ++var22) {
                this.regions[var21][var22].method4529(var5 + ((((this.regions[var21][var22].regionX * 64) - var19) * var18) / 64), var8 - (((((this.regions[var21][var22].regionY * 64) - var20) + 64) * var18) / 64), var18);
            }
        }
    }

    @ObfuscatedName("e")
    @ObfuscatedSignature(descriptor = "(IIIIIIIILjava/util/HashSet;Ljava/util/HashSet;IIZI)V", garbageValue = "-484400888")
    @Export("drawElements")
    public final void drawElements(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, HashSet var9, HashSet var10, int var11, int var12, boolean var13) {
        ...
        for (var19 = var14.x; var19 < (var14.width + var14.x); ++var19) {
            for (var20 = var14.y; var20 < (var14.height + var14.y); ++var20) {
                ...
                this.regions[var19][var20].method4458(var5 + ((((this.regions[var19][var20].regionX * 64) - var17) * var16) / 64), var8 - (((((this.regions[var19][var20].regionY * 64) - var18) + 64) * var16) / 64), var16, var9);
            }
        }
    ...
    @ObfuscatedName("r")
    @ObfuscatedSignature(descriptor = "(IIIILjava/util/HashSet;IIB)V", garbageValue = "-89")
    @Export("drawOverview")
    ...
    @ObfuscatedName("o")
    @ObfuscatedSignature(descriptor = "(IIIIIIIIIII)Ljava/util/List;", garbageValue = "418897328")
        ...
        if (!this.loaded) {
            ...
            for (int var17 = var12.x; var17 < (var12.x + var12.width); ++var17) {
                for (int var18 = var12.y; var18 < (var12.height + var12.y); ++var18) {
                    List var19 = this.regions[var17][var18].method4449(var5 + ((((this.regions[var17][var18].regionX * 64) - var15) * var14) / 64), (var8 + var6) - (((((this.regions[var17][var18].regionY * 64) - var16) + 64) * var14) / 64), var14, var9, var10);
                    if (!var19.isEmpty()) {
                        var11.addAll(var19);
                    }
                }
    ...
    @ObfuscatedName("i")
    @ObfuscatedSignature(descriptor = "(IIIII)Lhd;", garbageValue = "1144997050")
    ...
    @ObfuscatedName("v")
    @ObfuscatedSignature(descriptor = "(S)Ljava/util/HashMap;", garbageValue = "255")
    @Export("buildIcons")
    ...
    @ObfuscatedName("y")
    @ObfuscatedSignature(descriptor = "(III)F", garbageValue = "1867757238")
