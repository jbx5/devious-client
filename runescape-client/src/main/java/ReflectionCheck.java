...
public class ReflectionCheck extends Node {
   ...
   static final void drawEntities(int var0, int var1, int var2, int var3) {
      ...
      if (Client.oculusOrbState == 1 && Client.staffModLevel >= 2 && Client.cycle % 50 == 0 && (ObjectSound.oculusOrbFocalPointX >> 7 != class28.localPlayer.x >> 7 || class306.oculusOrbFocalPointY >> 7 != class28.localPlayer.y >> 7)) {
         ...
         var17 = class300.baseX * 64 + (ObjectSound.oculusOrbFocalPointX >> 7);
         var18 = Message.baseY * 64 + (class306.oculusOrbFocalPointY >> 7);
         PacketBufferNode var19 = class433.getPacketBufferNode(ClientPacket.field3016, Client.packetWriter.isaacCipher);
         var19.packetBuffer.method7762(var16);
         var19.packetBuffer.method7784(Client.field698);
         var19.packetBuffer.method7773(var18);
         var19.packetBuffer.method7773(var17);
