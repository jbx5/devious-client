	...
	static int method2440(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.MES) {
			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				PacketBufferNode var13 = class482.getPacketBufferNode(ClientPacket.field3239, Client.packetWriter.isaacCipher);
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					var7 = Interpreter.Interpreter_stringStack[--class211.Interpreter_stringStackSize];
					var11 = class482.getPacketBufferNode(ClientPacket.field3198, Client.packetWriter.isaacCipher);
					...
					var7 = Interpreter.Interpreter_stringStack[--class211.Interpreter_stringStackSize];
					var11 = class482.getPacketBufferNode(ClientPacket.field3204, Client.packetWriter.isaacCipher);
					var11.packetBuffer.writeByte(var7.length() + 1);
					var11.packetBuffer.writeStringCp1252NullTerminated(var7);
					Client.packetWriter.addNode(var11);
					return 1;
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						var3 = Interpreter.Interpreter_intStack[--UserComparator6.Interpreter_intStackSize];
						var11 = class482.getPacketBufferNode(ClientPacket.field3254, Client.packetWriter.isaacCipher);
