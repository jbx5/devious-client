...
public final class class332 {
	...
	static 
	{
		...
		for (int var0 = 0; var0 < class332.field4013.length; ++var0) {
			field4013[var0] = ((long) (Math.pow(37.0, ((double) (var0)))));
		}
	}

	@ObfuscatedName("ab")
	@ObfuscatedSignature(descriptor = "(ILbn;ZS)I", garbageValue = "7484")
