...
public class class131 extends class126 {
	...
	@ObfuscatedName("ga")
	@ObfuscatedGetter(intValue = -366800695)
	@Export("baseX")
	static int baseX;

	@ObfuscatedName("c")
	@ObfuscatedGetter(intValue = -564677501)
	int field1526;

	@ObfuscatedName("b")
	@ObfuscatedGetter(intValue = 165982009)
	int field1525;

	@ObfuscatedName("p")
	@ObfuscatedGetter(intValue = 1640415355)
	int field1528;

	@ObfuscatedName("m")
	@ObfuscatedGetter(intValue = 1105926385)
	int field1533;
