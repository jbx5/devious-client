...
public class VorbisSample extends Node {
	...
	float[] method1032(int var1) {
		...
		readBit();
		int var2 = readBits(DynamicObject.iLog(VorbisSample.VorbisSample_mapping.length - 1));
	...
	@ObfuscatedName("w")
	@ObfuscatedSignature(descriptor = "(Lku;)Z")
	...
	@ObfuscatedName("n")
	@ObfuscatedSignature(descriptor = "(Lku;II)Lae;")
