...
public class WorldMapRegion {
				...
				for (int var7 = 0; var7 < var6.length; ++var7) {
					...
					if (class101.method2640(var8.decoration)) {
						...
						if (var8.decoration == WorldMapDecorationType.field3826.id) {
							...
							if (var8.rotation == 1) {
								Rasterizer2D.method9410(this.pixelsPerTile * var1 + this.pixelsPerTile - 1, this.pixelsPerTile * (63 - var2), 1, var10);
							}
						...
						if (var8.decoration == WorldMapDecorationType.field3844.id) {
							...
							if (var11 == 0) {
								for (var12 = 0; var12 < this.pixelsPerTile; ++var12) {
									Rasterizer2D.method9410(var12 + this.pixelsPerTile * var1, (64 - var2) * this.pixelsPerTile - 1 - var12, 1, var10);
								}
							} else {
								for (var12 = 0; var12 < this.pixelsPerTile; ++var12) {
									Rasterizer2D.method9410(var12 + this.pixelsPerTile * var1, var12 + this.pixelsPerTile * (63 - var2), 1, var10);
								}
							}
						}
					}
	...
	void method5212(int var1, int var2, int var3, int var4) {
		...
		if (var3 == 3) {
			Rasterizer2D.method9410(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2) + this.pixelsPerTile - 1, this.pixelsPerTile, var4);
		}
