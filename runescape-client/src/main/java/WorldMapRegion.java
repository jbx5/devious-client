...
public class WorldMapRegion {
                  ...
                  if (var8.decoration == WorldMapDecorationType.field3542.id) {
                     ...
                     if (var13 == 0) {
                        for(var14 = 0; var14 < this.pixelsPerTile; ++var14) {
                           Rasterizer2D.method8058(var14 + this.pixelsPerTile * var1, (64 - var2) * this.pixelsPerTile - 1 - var14, 1, var12);
                        }
                     } else {
                        for(var14 = 0; var14 < this.pixelsPerTile; ++var14) {
                           Rasterizer2D.method8058(var14 + this.pixelsPerTile * var1, var14 + this.pixelsPerTile * (63 - var2), 1, var12);
                        }
                     }
                  }
               }
   ...
   void method4691(int var1, int var2, int var3, int var4) {
      ...
      if (var3 == 3) {
         Rasterizer2D.method8058(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2) + this.pixelsPerTile - 1, this.pixelsPerTile, var4);
      }
