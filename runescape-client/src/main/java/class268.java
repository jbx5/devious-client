...
public final class class268 {
	...
	"(Ljava/lang/String;I)Ljava/util/TimeZone;", garbageValue = 
	"-1547649433")
	...
	static void resumePauseWidget(int var0, int var1) {
		PacketBufferNode var2 = WorldMapSprite.getPacketBufferNode(ClientPacket.RESUME_PAUSEBUTTON, Client.packetWriter.isaacCipher);
									...
									if (var10.type == 4) {
										...
										if (var39 == null) {
											...
											if (var10.isIf3 && (var10.itemId != (-1))) {
												ItemComposition var45 = class19.ItemDefinition_get(var10.itemId);
												var44 = var45.name;
												if (var44 == null) {
													var44 = "null";
												}
										...
										if (var10.type == 6) {
											...
											var22 = 0;
											if (var10.itemId != (-1)) {
												var33 = class19.ItemDefinition_get(var10.itemId);
												if (var33 != null) {
												...
												for (var21 = 0; var21 < var10.rawHeight; ++var21) {
													for (var22 = 0; var22 < var10.rawWidth; ++var22) {
														if (var10.itemIds[var20] > 0) {
															var33 = class19.ItemDefinition_get(var10.itemIds[var20] - 1);
															String var34;
