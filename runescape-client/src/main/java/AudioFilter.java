...
public class AudioFilter {
   @ObfuscatedName("j")
   static float[][] field426 = new float[2][8];
   @ObfuscatedName("y")
   @Export("coefficients")
   ...
   int[] pairs = new int[2];
   @ObfuscatedName("c")
   int[][][] field423 = new int[2][2][4];
   @ObfuscatedName("x")
   int[][][] field424 = new int[2][2][4];
   @ObfuscatedName("h")
   int[] field425 = new int[2];
   ...
   int compute(int var1, float var2) {
      ...
      if (var1 == 0) {
         ...
         var3 *= 0.0030517578F;
         field421 = (float)Math.pow(0.1, (double)(var3 / 20.0F));
