...
public class AudioFilter {
	...
	AudioFilter() {
		...
		this.field392 = new int[2][2][4];
		this.field393 = new int[2];
	}

	@ObfuscatedName("aq")
	float method1146(int var1, int var2, float var3) {
		float var4 = (float)this.field392[var1][0][var2] + var3 * (float)(this.field392[var1][1][var2] - this.field392[var1][0][var2]);
		var4 *= 0.0015258789F;
	...
	int compute(int var1, float var2) {
		float var3;
		if (var1 == 0) {
			var3 = (float)this.field393[0] + (float)(this.field393[1] - this.field393[0]) * var2;
			var3 *= 0.0030517578F;
		...
		if (this.pairs[var1] == 0) {
			...
			field399[var1][0] = -2.0F * var3 * (float)Math.cos((double)this.method1152(var1, 0, var2));
			...
			for (var4 = 1; var4 < this.pairs[var1]; ++var4) {
				...
				float var5 = -2.0F * var3 * (float)Math.cos((double)this.method1152(var1, var4, var2));
	...
	final void method1149(Buffer var1, SoundEnvelope var2) {
		...
		if (var3 != 0) {
			this.field393[0] = var1.readUnsignedShort();
			this.field393[1] = var1.readUnsignedShort();
			...
			for (var5 = 0; var5 < 2; ++var5) {
				for (var6 = 0; var6 < this.pairs[var5]; ++var6) {
					...
					this.field392[var5][0][var6] = var1.readUnsignedShort();
				}
			}
			...
			for (var5 = 0; var5 < 2; ++var5) {
				for (var6 = 0; var6 < this.pairs[var5]; ++var6) {
					if ((var7 & 1 << var5 * 4 << var6) != 0) {
						...
						this.field392[var5][1][var6] = var1.readUnsignedShort();
					} else {
						this.field391[var5][1][var6] = this.field391[var5][0][var6];
						this.field392[var5][1][var6] = this.field392[var5][0][var6];
					}
				}
			}

			if (var7 != 0 || this.field393[1] != this.field393[0]) {
