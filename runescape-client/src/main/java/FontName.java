...
public class FontName {
	...
	@ObfuscatedName("c")
	@ObfuscatedSignature(descriptor = "(B)[Lpd;", garbageValue = "0")
	...
	@ObfuscatedName("c")
	@ObfuscatedSignature(descriptor = "(II)Z", garbageValue = "-1771875487")
	public static boolean method7385(int var0) {
		return (var0 & 1) != 0;
	}

	@ObfuscatedName("w")
	@ObfuscatedSignature(descriptor = "(II)Z", garbageValue = "1224707658")
