...
public class MouseRecorder implements Runnable {
	...
	public void run() {
		for (; this.isRunning; FileSystem.method4499(50L)) {
	...
	public static ItemComposition ItemDefinition_get(int var0) {
		...
		if (var1 != null) {
			...
			if (!class191.ItemDefinition_inMembersWorld && var1.isMembersOnly) {
				...
				if (var1.params != null) {
					...
					for (Node var4 = var1.params.first(); var4 != null; var4 = var1.params.next()) {
						ParamComposition var5 = class432.getParamDefinition((int)var4.key);
						if (var5.autoDisable) {
							var4.remove();
						} else {
							var6 = true;
