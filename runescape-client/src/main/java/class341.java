...
public class class341 {
	@ObfuscatedName("ax")
	@ObfuscatedSignature(descriptor = "(ILbn;ZB)I", garbageValue = "6")
				...
				if (var3 == 0) {
					...
					switch (var4) {
						...
						case 4 :
							...
							break;
						default :
							Interpreter.Interpreter_intStack[(++IsaacCipher.Interpreter_intStackSize) - 1] = ((int) (Math.pow(((double) (var3)), 1.0 / ((double) (var4)))));}
	...
	@ObfuscatedName("gx")
	@ObfuscatedSignature(descriptor = "(I)V", garbageValue = "1492532048")
