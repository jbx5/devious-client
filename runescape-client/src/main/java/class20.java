...
public class class20 implements Callable {
	@ObfuscatedName("kk")
	@ObfuscatedGetter(intValue = -943773093)
	@Export("Client_plane")
	static int Client_plane;

	@ObfuscatedName("no")
	@ObfuscatedGetter(intValue = -1799052417)
	...
	@ObfuscatedSignature(descriptor = "(Lg;Lo;)V")
	...
	@ObfuscatedName("c")
	@ObfuscatedSignature(descriptor = "(II)Z", garbageValue = "-76614425")
	public static boolean method332(int var0) {
		return (var0 & 1) != 0;
	}

	@ObfuscatedName("ke")
	@ObfuscatedSignature(descriptor = "(II)V", garbageValue = "-1917740045")
