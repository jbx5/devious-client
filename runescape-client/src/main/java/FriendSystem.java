		...
		if (var1 != null) {
			...
			if (var2.hasCleanName()) {
				if (this.friendsList.removeByUsername(var2)) {
					...
					PacketBufferNode var3 = class503.getPacketBufferNode(ClientPacket.field3114, Client.packetWriter.isaacCipher);
		...
		if (var1 != null) {
			...
			if (var3.hasCleanName()) {
				if (this.ignoreList.removeByUsername(var3)) {
					Client.field763 = Client.cycleCntr;
					if (var2) {
						PacketBufferNode var4 = class503.getPacketBufferNode(ClientPacket.field3155, Client.packetWriter.isaacCipher);
