...
public abstract class class292 implements class294 {
	...
	static final void method5834(int var0, int var1, boolean var2) {
		if (!var2 || var0 != DefaultsGroup.field4740 || class223.field2367 != var1) {
			DefaultsGroup.field4740 = var0;
			class223.field2367 = var1;
			WorldMapSection2.updateGameState(25);
			LoginPacket.drawLoadingMessage("Loading - please wait.", true);
			int var3 = NpcOverrides.baseX * 64;
			int var4 = class101.baseY * 64;
			NpcOverrides.baseX = (var0 - 6) * 8;
			class101.baseY = (var1 - 6) * 8;
			int var5 = NpcOverrides.baseX * 64 - var3;
			int var6 = class101.baseY * 64 - var4;
			var3 = NpcOverrides.baseX * 64;
