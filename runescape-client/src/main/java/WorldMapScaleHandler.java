...
public class WorldMapScaleHandler {
    @ObfuscatedName("c")
    @ObfuscatedGetter(intValue = -1816368845)
    ...
    @ObfuscatedName("c")
    @ObfuscatedSignature(descriptor = "(IIIIIIIIB)V", garbageValue = "-80")
    ...
    @ObfuscatedName("l")
    @ObfuscatedSignature(descriptor = "(III)I", garbageValue = "748543356")
    ...
    @ObfuscatedName("e")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "-325393")
    @Export("init")
    void init() {
    ...
    @ObfuscatedName("r")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "-452375547")
    @Export("init0")
    void init0() {
    ...
    @ObfuscatedName("i")
    @ObfuscatedSignature(descriptor = "(S)V", garbageValue = "-6837")
    @Export("init2")
    void init2() {
        byte[] var1 = new byte[this.pixelsPerTile * this.pixelsPerTile];
        int var2 = 0;
    ...
    @ObfuscatedName("w")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "-1199592134")
    @Export("init3")
    void init3() {
        byte[] var1 = new byte[this.pixelsPerTile * this.pixelsPerTile];
        int var2 = 0;
    ...
    @ObfuscatedName("a")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "1595535604")
    @Export("init5")
    void init5() {
        byte[] var1 = new byte[this.pixelsPerTile * this.pixelsPerTile];
        boolean var2 = false;
    ...
    @ObfuscatedName("y")
    @ObfuscatedSignature(descriptor = "(I)V", garbageValue = "340904803")
    @Export("init6")
    void init6() {
        byte[] var1 = new byte[this.pixelsPerTile * this.pixelsPerTile];
        boolean var2 = false;
