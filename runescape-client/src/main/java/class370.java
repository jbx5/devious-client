...
public class class370 implements class375 {
	...
	@ObfuscatedSignature(descriptor = "(Lom;)V")
	class370(class398 var1) {
		this.field4221 = var1;
	}

	@ObfuscatedSignature(descriptor = "(Lnl;)V")
	public class370(class371 var1) {
		this(new class398(var1));
	}

	@ObfuscatedName("c")
	@ObfuscatedSignature(descriptor = "(II)I", garbageValue = "2038166552")
	public int method6757(int var1) {
		return this.field4221.vmethod7128(var1);
	}

	@ObfuscatedName("c")
	@ObfuscatedSignature(descriptor = "(Lpi;Ljava/lang/String;S)I", garbageValue = "267")
