...
class class141 implements Callable {
	...
	public static void method3201(AbstractArchive var0) {
		class292.InvDefinition_archive = var0;
	}
	...
	static Script getScript(int var0, int var1) {
		...
		if (var2 != null) {
			...
			int var4 = WorldEntity.archive12.getGroupId(var3);
			if (var4 == -1) {
				return null;
			} else {
				byte[] var5 = WorldEntity.archive12.takeFileFlat(var4);
				if (var5 != null) {
					if (var5.length <= 1) {
						return null;
					}

					var2 = class154.newScript(var5);
					if (var2 != null) {
