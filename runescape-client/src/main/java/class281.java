...
public class class281 {
	...
	@ObfuscatedName("kx")
	@ObfuscatedSignature(descriptor = "(II)V", garbageValue = "1649545590")
	...
	static final void changeGameOptions(int var0) {
		...
		if (var1 != 0) {
			...
			if (var1 == 1) {
				if (var2 == 1) {
					InterfaceParent.method2142(0.9);
				}
				if (var2 == 2) {
					InterfaceParent.method2142(0.8);
				}
				if (var2 == 3) {
					InterfaceParent.method2142(0.7);
				}
				if (var2 == 4) {
					InterfaceParent.method2142(0.6);
				}
			}
			if (var1 == 3) {
				if (var2 == 0) {
