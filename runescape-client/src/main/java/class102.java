...
public class class102 {
	...
	static final void method2657(PacketBuffer var0) {
		for (int var1 = 0; var1 < Client.field571; ++var1) {
			...
			int var9;
			if ((var4 & 65536) != 0) {
				var5 = var0.method9298();

				for (var6 = 0; var6 < var5; ++var6) {
					var7 = var0.method9462();
			...
			if ((var4 & 8192) != 0) {
				...
				var3.field1256 = var0.readUnsignedByteNeg() + Client.cycle;
				var3.field1203 = var0.readUnsignedByteAdd();
				var3.pathLength = 1;
				var3.field1274 = 0;
			...
			if ((var4 & 512) != 0) {
				...
				if ((var5 & 1) == 1) {
					...
					if ((var5 & 8) == 8) {
						...
						for (var10 = 0; var10 < var9; ++var10) {
							var15[var10] = (short)var0.readUnsignedByteAdd();
						}
					}
			...
			if ((var4 & 16) != 0) {
				var3.definition = UserComparator10.getNpcDefinition(var0.readUnsignedByteAdd());
				SoundCache.method843(var3);
				var3.method2590();
			}

			if ((var4 & 2048) != 0) {
				var3.field1275 = var0.readUnsignedShortLE();
			}
				...
				if (var6 > 0) {
					for (var7 = 0; var7 < var6; ++var7) {
						...
						if (var9 != 32767) {
							...
							int var12 = var9 > 0 ? var0.method9298() : var11;
			...
			if ((var4 & 262144) != 0) {
				...
				var3.turnRightSequence = (var5 & 2) != 0 ? var0.readUnsignedByteAdd() : var3.definition.turnRightSequence;
				...
				var3.walkLeftSequence = (var5 & 16) != 0 ? var0.readUnsignedByteAdd() : var3.definition.walkLeftSequence;
				var3.walkRightSequence = (var5 & 32) != 0 ? var0.readUnsignedByteNeg() : var3.definition.walkRightSequence;
				...
				var3.field1215 = (var5 & 512) != 0 ? var0.readUnsignedByteNeg() : var3.definition.field2111;
				var3.field1264 = (var5 & 1024) != 0 ? var0.readUnsignedShortAdd() : var3.definition.field2121;
				var3.field1269 = (var5 & 2048) != 0 ? var0.readUnsignedByteNeg() : var3.definition.field2122;
				var3.field1218 = (var5 & 4096) != 0 ? var0.readUnsignedByteAdd() : var3.definition.field2123;
				var3.field1226 = (var5 & 8192) != 0 ? var0.readUnsignedByteNeg() : var3.definition.field2124;
