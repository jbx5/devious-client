...
public class class136 extends class126 {
	...
	@ObfuscatedName("c")
	@ObfuscatedGetter(intValue = -1563253375)
	int field1556;
	...
	@ObfuscatedName("c")
	@ObfuscatedSignature(descriptor = "(Ljava/awt/Component;I)V", garbageValue = "-54146153")
	...
	@ObfuscatedName("b")
	@ObfuscatedSignature(descriptor = "(CB)Z", garbageValue = "-10")
	...
	@ObfuscatedName("t")
	@ObfuscatedSignature(descriptor = "(IB)Z", garbageValue = "-56")
	public static boolean method2841(int var0) {
		return ((var0 >> 20) & 1) != 0;
	}

	@ObfuscatedName("ic")
	@ObfuscatedSignature(descriptor = "(ILjava/lang/String;I)V", garbageValue = "429003988")
