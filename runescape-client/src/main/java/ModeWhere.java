   ...
   static int method6095(int var0, Script var1, boolean var2) {
      ...
      if (var0 == ScriptOpcodes.MES) {
         ...
         if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
            ...
            PacketBufferNode var13 = class433.getPacketBufferNode(ClientPacket.field2938, Client.packetWriter.isaacCipher);
            ...
            if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
               var7 = Interpreter.Interpreter_stringStack[--GrandExchangeOfferAgeComparator.Interpreter_stringStackSize];
               var11 = class433.getPacketBufferNode(ClientPacket.field2964, Client.packetWriter.isaacCipher);
               ...
               var7 = Interpreter.Interpreter_stringStack[--GrandExchangeOfferAgeComparator.Interpreter_stringStackSize];
               var11 = class433.getPacketBufferNode(ClientPacket.field2945, Client.packetWriter.isaacCipher);
               var11.packetBuffer.writeByte(var7.length() + 1);
               var11.packetBuffer.writeStringCp1252NullTerminated(var7);
               Client.packetWriter.addNode(var11);
               return 1;
               ...
               if (var0 == ScriptOpcodes.OPPLAYER) {
                  ...
                  var10 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize];
                  var11 = class433.getPacketBufferNode(ClientPacket.field2982, Client.packetWriter.isaacCipher);
                  ...
                  if (var4.length() > 500) {
                     ...
                     var6.packetBuffer.method7762(var10);
