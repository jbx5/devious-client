...
public enum ModeWhere implements MouseWheel {
	...
	@ObfuscatedName("c")
	@ObfuscatedSignature(descriptor = "Llq;")
	...
	@ObfuscatedName("sl")
	@ObfuscatedGetter(intValue = -1096965871)
	...
	@ObfuscatedName("ms")
	@ObfuscatedGetter(intValue = -936877643)
	@Export("menuX")
	static int menuX;

	@ObfuscatedName("h")
	@ObfuscatedGetter(intValue = -91884081)
	@Export("id")
	final int id;
	...
	@ObfuscatedName("ht")
	@ObfuscatedSignature(descriptor = "(IIIB)V", garbageValue = "14")
