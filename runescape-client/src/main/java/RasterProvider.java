...
public final class RasterProvider extends AbstractRasterProvider {
    ...
    @ObfuscatedName("c")
    @ObfuscatedSignature(descriptor = "(Ljava/awt/Component;I)V", garbageValue = "980097232")
    @Export("setComponent")
    ...
    @ObfuscatedName("s")
    @ObfuscatedSignature(descriptor = "(IIIII)V", garbageValue = "805431680")
    @Export("draw")
    ...
    @ObfuscatedName("e")
    @ObfuscatedSignature(descriptor = "(Ljava/awt/Graphics;IIB)V", garbageValue = "0")
    @Export("drawFull0")
    ...
    @ObfuscatedName("r")
    @ObfuscatedSignature(descriptor = "(Ljava/awt/Graphics;IIIIB)V", garbageValue = "32")
    @Export("draw0")
