...
public class class231 {
    ...
    @ObfuscatedName("s")
    @ObfuscatedGetter(intValue = -1261525221)
    @Export("value")
    final int value;
    ...
    @ObfuscatedName("l")
    @ObfuscatedSignature(descriptor = "(IB)Lpy;", garbageValue = "6")
    ...
    @ObfuscatedName("y")
    @ObfuscatedSignature(descriptor = "(IIIIIILgn;Lgi;B)V", garbageValue = "-101")
            ...
            if (var5 == 22) {
                ...
                if ((var5 != 10) && (var5 != 11)) {
                    ...
                    if (var5 >= 12) {
                        ...
                        var6.newBoundaryObject(var0, var1, var2, var16, ((Renderable) (var29)), ((Renderable) (null)), Tiles.field999[var4], 0, var19, var21);
                        if (var4 == 0) {
                            if (var8.clipped) {
                        ...
                        var6.newBoundaryObject(var0, var1, var2, var16, ((Renderable) (var29)), ((Renderable) (null)), Tiles.field1000[var4], 0, var19, var21);
                        if (var8.clipped) {
                            if (var4 == 0) {
                                class260.field3078[var0][var1][var2 + 1] = 50;
                            } else if (var4 == 1) {
                        ...
                        if (var5 == 2) {
                            ...
                            var6.newBoundaryObject(var0, var1, var2, var16, ((Renderable) (var30)), ((Renderable) (var24)), Tiles.field999[var4], Tiles.field999[var22], var19, var21);
                            if (var8.modelClipped) {
                                if (var4 == 0) {
                                    var10000 = class78.field1033[var0][var1];
                                    var10000[var2] |= 585;
                            ...
                            var6.newWallDecoration(var0, var1, var2, var16, ((Renderable) (var29)), ((Renderable) (null)), Tiles.field999[var4], 0, 0, 0, var19, var21);
                        } else {
                            long var23;
                            Object var25;
                            if (var5 == 5) {
                                ...
                                var6.newWallDecoration(var0, var1, var2, var16, ((Renderable) (var25)), ((Renderable) (null)), Tiles.field999[var4], 0, var22 * Tiles.field1001[var4], var22 * Tiles.field1002[var4], var19, var21);
                            } else if (var5 == 6) {
                                var22 = 8;
                                var23 = var6.getBoundaryObjectTag(var0, var1, var2);
                                if (0L != var23) {
                                ...
                                var6.newWallDecoration(var0, var1, var2, var16, ((Renderable) (var25)), ((Renderable) (null)), 256, var4, var22 * Tiles.field1003[var4], var22 * Tiles.field1005[var4], var19, var21);
                            } else if (var5 == 7) {
                                var28 = (var4 + 2) & 3;
                                if ((var8.animationId == (-1)) && (var8.transforms == null)) {
                                ...
                                var6.newWallDecoration(var0, var1, var2, var16, ((Renderable) (var25)), ((Renderable) (var26)), 256, var4, var22 * Tiles.field1003[var4], var22 * Tiles.field1005[var4], var19, var21);
                            }
                        }
                    }
                } else {
    ...
    @ObfuscatedName("jj")
    @ObfuscatedSignature(descriptor = "(II)Ljava/lang/String;", garbageValue = "-32113646")
