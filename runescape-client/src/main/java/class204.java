...
public class class204 implements WorldMapSection {
	...
	public int[] getBorderTileLengths(int var1, int var2, int var3) {
		if (!this.containsCoord(var1, var2, var3)) {
			...
			int[] var4 = new int[]{ (var2 + ((this.field2290 * 64) - (this.field2288 * 64))) + ((this.field2286 * 8) - (this.field2295 * 8)), (var3 + ((this.field2291 * 64) - (this.field2289 * 64))) + ((this.field2292 * 8) - (this.field2293 * 8)) };
			return var4;
		}
	}
	...
	public Coord coord(int var1, int var2) {
		if (!this.containsPosition(var1, var2)) {
			...
			int var4 = (var2 + ((this.field2289 * 64) - (this.field2291 * 64))) + ((this.field2293 * 8) - (this.field2292 * 8));
