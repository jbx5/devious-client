...
public class class65 {
	...
	@ObfuscatedName("s")
	@ObfuscatedSignature(descriptor = "(Lpj;ILck;II)V", garbageValue = "-2002121485")
	static final void method1957(PacketBuffer var0, int var1, Player var2, int var3) {
		...
		if ((var3 & 16384) != 0) {
			var2.field1132 = var0.readByteNeg();
			var2.field1134 = var0.readByteNeg();
			var2.field1133 = var0.readByteSub();
			var2.field1135 = var0.readByteSub();
			var2.field1136 = var0.readUnsignedShortAddLE() + Client.cycle;
			var2.field1157 = var0.readUnsignedShortAddLE() + Client.cycle;
			var2.field1138 = var0.readUnsignedShortAdd();
			if (var2.field1055) {
		...
		if ((var3 & 1) != 0) {
			...
			var0.readBytesAdd(var13, 0, var5);
		...
		if ((var3 & 32) != 0) {
			...
			PlayerType var19 = ((PlayerType) (class130.findEnumerated(SpotAnimationDefinition.PlayerType_values(), var0.readUnsignedByteNeg())));
			boolean var17 = var0.readUnsignedByteSub() == 1;
		...
		if ((var3 & 512) != 0) {
			var2.field1141 = Client.cycle + var0.readUnsignedShortAddLE();
			var2.field1140 = Client.cycle + var0.readUnsignedShortAdd();
			var2.field1143 = var0.readByte();
			var2.field1144 = var0.readByteSub();
			var2.field1095 = var0.readByte();
			var2.field1146 = ((byte) (var0.readUnsignedByte()));
		}
		if ((var3 & 64) != 0) {
			var2.field1122 = var0.readUnsignedShortLE();
	...
	@ObfuscatedName("fx")
	@ObfuscatedSignature(descriptor = "(I)V", garbageValue = "843672691")
