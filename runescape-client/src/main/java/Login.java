...
public class Login {
   ...
   static int method1996(int var0, Script var1, boolean var2) {
      if (var0 == ScriptOpcodes.CHAT_GETFILTER_PUBLIC) {
         ...
         PacketBufferNode var13 = class433.getPacketBufferNode(ClientPacket.field2919, Client.packetWriter.isaacCipher);
         ...
         if (var0 == ScriptOpcodes.CHAT_SENDABUSEREPORT) {
            ...
            var6 = class433.getPacketBufferNode(ClientPacket.field3014, Client.packetWriter.isaacCipher);
            ...
            if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYTYPEANDLINE) {
               ...
               if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYUID) {
                  ...
                  if (var0 == ScriptOpcodes.CHAT_SENDPUBLIC) {
                     ...
                     var12 = class433.getPacketBufferNode(ClientPacket.field3001, Client.packetWriter.isaacCipher);
