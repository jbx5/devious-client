...
public class VorbisFloor {
	...
	VorbisFloor() {
		...
		if (var1 != 1) { // L: 109
			...
			this.field276 = new int[var5]; // L: 137
			this.field276[0] = 0; // L: 138
			this.field276[1] = 1 << var4; // L: 139
			var5 = 2; // L: 140
			...
			if (field274 == null || field274.length < var5) { // L: 145
				field274 = new int[var5]; // L: 146
				field284 = new int[var5]; // L: 147
				field281 = new boolean[var5]; // L: 148
			}
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) { // L: 83
			int var3 = var1; // L: 84
			int var4 = field274[var1]; // L: 85
			int var5 = field284[var1]; // L: 86
			boolean var6 = field281[var1]; // L: 87

			for (int var7 = var1 + 1; var7 <= var2; ++var7) { // L: 88
				int var8 = field274[var7]; // L: 89
				if (var8 < var4) { // L: 90
					field274[var3] = var8; // L: 91
					field284[var3] = field284[var7]; // L: 92
					field281[var3] = field281[var7]; // L: 93
					++var3; // L: 94
					field274[var7] = field274[var3]; // L: 95
					field284[var7] = field284[var3]; // L: 96
					field281[var7] = field281[var3]; // L: 97
				}
			}

			field274[var3] = var4; // L: 100
			field284[var3] = var5; // L: 101
			field281[var3] = var6; // L: 102
	...
	boolean readSubmapFloor() {
		...
		if (!var1) { // L: 154
			...
			int var2 = this.field276.length; // L: 155
			...
			var3 = field285[this.multiplier - 1]; // L: 157
			int var4 = Archive.iLog(var3 - 1); // L: 158
			field284[0] = VorbisSample.readBits(var4); // L: 159
			field284[1] = VorbisSample.readBits(var4); // L: 160
			int var5 = 2; // L: 161
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) { // L: 162
				...
				for (int var12 = 0; var12 < var8; ++var12) { // L: 169
					...
					var11 >>>= var9; // L: 171
					field284[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method1044() : 0; // L: 172
				}
			}
	...
	void method715(float[] var1, int var2) {
		int var3 = this.field276.length; // L: 179
		int var4 = field285[this.multiplier - 1]; // L: 180
		boolean[] var5 = field281; // L: 181
		field281[1] = true; // L: 182
		var5[0] = true; // L: 183
		...
		for (var6 = 2; var6 < var3; ++var6) { // L: 184
			var7 = method710(field274, var6); // L: 185
			var8 = method720(field274, var6); // L: 186
			var9 = this.method713(field274[var7], field284[var7], field274[var8], field284[var8], field274[var6]); // L: 187
			var10 = field284[var6]; // L: 188
			int var11 = var4 - var9; // L: 189
			int var13 = (var11 < var9 ? var11 : var9) << 1; // L: 191
			if (var10 != 0) { // L: 192
				boolean[] var14 = field281; // L: 193
				field281[var8] = true; // L: 195
				var14[var7] = true; // L: 196
				field281[var6] = true; // L: 197
				if (var10 >= var13) { // L: 198
					field284[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1; // L: 199
				} else {
					field284[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9; // L: 202
				}
			} else {
				field281[var6] = false; // L: 206
				field284[var6] = var9; // L: 207
			}
		}

		this.VarbisFloor_sort(0, var3 - 1); // L: 210
		var6 = 0; // L: 211
		var7 = field284[0] * this.multiplier; // L: 212

		for (var8 = 1; var8 < var3; ++var8) { // L: 213
			if (field281[var8]) { // L: 214
				var9 = field274[var8]; // L: 215
				var10 = field284[var8] * this.multiplier; // L: 216
				this.method729(var6, var7, var9, var10, var1, var2); // L: 217
				if (var9 >= var2) { // L: 218
					return;
				}
