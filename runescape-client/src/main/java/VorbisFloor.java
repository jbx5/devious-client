...
public class VorbisFloor {
	...
	static {
		field264 = new int[]{ 256, 128, 86, 64 };
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field262 = new int[var5];
			this.field262[0] = 0;
			this.field262[1] = 1 << var4;
			var5 = 2;
			for (var6 = 0; var6 < var2; ++var6) {
			...
			if (field271 == null || VorbisFloor.field271.length < var5) {
				field271 = new int[var5];
				field272 = new int[var5];
				field273 = new boolean[var5];
			}
		}
	}
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = field271[var1];
			int var5 = field272[var1];
			boolean var6 = field273[var1];
			for (int var7 = var1 + 1; var7 <= var2; ++var7) {
				int var8 = field271[var7];
				if (var8 < var4) {
					field271[var3] = var8;
					field272[var3] = field272[var7];
					field273[var3] = field273[var7];
					++var3;
					field271[var7] = field271[var3];
					field272[var7] = field272[var3];
					field273[var7] = field273[var3];
				}
			}
			field271[var3] = var4;
			field272[var3] = var5;
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			int var2 = this.field262.length;
			int var3;
			for (var3 = 0; var3 < var2; ++var3) {
				field271[var3] = this.field262[var3];
			}
			var3 = field264[this.multiplier - 1];
			int var4 = Messages.iLog(var3 - 1);
			field272[0] = VorbisSample.readBits(var4);
			field272[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				for (int var12 = 0; var12 < var8; ++var12) {
					...
					var11 >>>= var9;
					field272[var5++] = (var13 >= 0) ? VorbisSample.VorbisSample_codebooks[var13].method956() : 0;
				}
			}
			return true;
		}
	...
	void method643(float[] var1, int var2) {
		int var3 = this.field262.length;
		int var4 = field264[this.multiplier - 1];
		boolean[] var5 = field273;
		field273[1] = true;
		var5[0] = true;
		int var6;
		int var7;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method656(field271, var6);
			var8 = method637(field271, var6);
			var9 = this.method638(field271[var7], field272[var7], field271[var8], field272[var8], field271[var6]);
			var10 = field272[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field273;
				field273[var8] = true;
				var14[var7] = true;
				field273[var6] = true;
				if (var10 >= var13) {
					field272[var6] = (var11 > var9) ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field272[var6] = ((var10 & 1) != 0) ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field273[var6] = false;
				field272[var6] = var9;
		...
		var6 = 0;
		var7 = field272[0] * this.multiplier;
		for (var8 = 1; var8 < var3; ++var8) {
			if (field273[var8]) {
				var9 = field271[var8];
				var10 = field272[var8] * this.multiplier;
				this.method639(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
				var6 = var9;
