...
public class VorbisFloor {
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field268 = new int[var5];
			this.field268[0] = 0;
			this.field268[1] = 1 << var4;
			var5 = 2;
			for (var6 = 0; var6 < var2; ++var6) {
			...
			if ((field279 == null) || (VorbisFloor.field279.length < var5)) {
				field279 = new int[var5];
				field278 = new int[var5];
				field277 = new boolean[var5];
			}
		}
	}
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = field279[var1];
			int var5 = field278[var1];
			boolean var6 = field277[var1];
			for (int var7 = var1 + 1; var7 <= var2; ++var7) {
				int var8 = field279[var7];
				if (var8 < var4) {
					field279[var3] = var8;
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			var3 = field274[this.multiplier - 1];
			int var4 = DynamicObject.iLog(var3 - 1);
			field278[0] = VorbisSample.readBits(var4);
			field278[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				for (int var12 = 0; var12 < var8; ++var12) {
					...
					var11 >>>= var9;
					field278[var5++] = (var13 >= 0) ? VorbisSample.VorbisSample_codebooks[var13].method1013() : 0;
				}
			}
			return true;
		}
	...
	void method728(float[] var1, int var2) {
		...
		int var4 = field274[this.multiplier - 1];
		boolean[] var5 = field277;
		field277[1] = true;
		var5[0] = true;
		int var6;
		int var7;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			...
			var9 = this.method726(field279[var7], field278[var7], field279[var8], field278[var8], field279[var6]);
			var10 = field278[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field277;
				field277[var8] = true;
				var14[var7] = true;
				field277[var6] = true;
				if (var10 >= var13) {
					field278[var6] = (var11 > var9) ? var9 + (var10 - var9) : (var11 + (var9 - var10)) - 1;
				} else {
					field278[var6] = ((var10 & 1) != 0) ? var9 - ((var10 + 1) / 2) : (var10 / 2) + var9;
				}
			} else {
				field277[var6] = false;
				field278[var6] = var9;
		...
		var6 = 0;
		var7 = field278[0] * this.multiplier;
		for (var8 = 1; var8 < var3; ++var8) {
			if (field277[var8]) {
				var9 = field279[var8];
				var10 = field278[var8] * this.multiplier;
				this.method723(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
				var6 = var9;
