...
public class VorbisFloor {
   @ObfuscatedName("aj")
   static final int[] field280 = new int[]{256, 128, 86, 64};
   @ObfuscatedName("al")
   ...
   VorbisFloor() {
      ...
      if (var1 != 1) {
         ...
         this.field273 = new int[var5];
         this.field273[0] = 0;
         this.field273[1] = 1 << var4;
         var5 = 2;
         ...
         if (field282 == null || field282.length < var5) {
            field282 = new int[var5];
            field281 = new int[var5];
            field275 = new boolean[var5];
         }
   ...
   void VarbisFloor_sort(int var1, int var2) {
      if (var1 < var2) {
         int var3 = var1;
         int var4 = field282[var1];
         int var5 = field281[var1];
         boolean var6 = field275[var1];

         for(int var7 = var1 + 1; var7 <= var2; ++var7) {
            int var8 = field282[var7];
            if (var8 < var4) {
               field282[var3] = var8;
               field281[var3] = field281[var7];
               field275[var3] = field275[var7];
               ++var3;
               field282[var7] = field282[var3];
   ...
   boolean readSubmapFloor() {
      ...
      if (!var1) {
         ...
         field281[0] = VorbisSample.readBits(var4);
         field281[1] = VorbisSample.readBits(var4);
         int var5 = 2;
         ...
         for(int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
            ...
            for(int var12 = 0; var12 < var8; ++var12) {
               ...
               var11 >>>= var9;
               field281[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method1055() : 0;
            }
         }
   ...
   void method741(float[] var1, int var2) {
      int var3 = this.field273.length;
      int var4 = field280[this.multiplier - 1];
      boolean[] var5 = field275;
      field275[1] = true;
      var5[0] = true;
      ...
      for(var6 = 2; var6 < var3; ++var6) {
         var7 = method758(field282, var6);
         var8 = method736(field282, var6);
         var9 = this.method754(field282[var7], field281[var7], field282[var8], field281[var8], field282[var6]);
         var10 = field281[var6];
         int var11 = var4 - var9;
         int var13 = (var11 < var9 ? var11 : var9) << 1;
         if (var10 != 0) {
            boolean[] var14 = field275;
            field275[var8] = true;
            var14[var7] = true;
            field275[var6] = true;
            if (var10 >= var13) {
               field281[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
            } else {
               field281[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
            }
         } else {
            field275[var6] = false;
            field281[var6] = var9;
      ...
      var6 = 0;
      var7 = field281[0] * this.multiplier;

      for(var8 = 1; var8 < var3; ++var8) {
         if (field275[var8]) {
            var9 = field282[var8];
            var10 = field281[var8] * this.multiplier;
            this.method738(var6, var7, var9, var10, var1, var2);
            if (var9 >= var2) {
               return;
            }
