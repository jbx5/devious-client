...
public class VorbisFloor {
	@ObfuscatedName("o")
	static final int[] field283 = new int[]{ 256, 128, 86, 64 };
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			if (field284 == null || VorbisFloor.field284.length < var5) {
				field284 = new int[var5];
				field276 = new int[var5];
				field279 = new boolean[var5];
			}
		}
	}
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			var3 = field283[this.multiplier - 1];
			int var4 = class263.iLog(var3 - 1);
			field276[0] = VorbisSample.readBits(var4);
			field276[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				for (int var12 = 0; var12 < var8; ++var12) {
					...
					var11 >>>= var9;
					field276[var5++] = (var13 >= 0) ? VorbisSample.VorbisSample_codebooks[var13].method973() : 0;
				}
			}
			return true;
		}
	...
	void method677(float[] var1, int var2) {
		...
		int var4 = field283[this.multiplier - 1];
		boolean[] var5 = field279;
		field279[1] = true;
		var5[0] = true;
		int var6;
		int var7;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method687(field284, var6);
			var8 = method672(field284, var6);
			var9 = this.method673(field284[var7], field276[var7], field284[var8], field276[var8], field284[var6]);
			var10 = field276[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field279;
				field279[var8] = true;
				var14[var7] = true;
				field279[var6] = true;
				if (var10 >= var13) {
					field276[var6] = (var11 > var9) ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field276[var6] = ((var10 & 1) != 0) ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field279[var6] = false;
				field276[var6] = var9;
		...
		var6 = 0;
		var7 = field276[0] * this.multiplier;
		for (var8 = 1; var8 < var3; ++var8) {
			if (field279[var8]) {
				var9 = field284[var8];
				var10 = field276[var8] * this.multiplier;
				this.method674(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
				var6 = var9;
