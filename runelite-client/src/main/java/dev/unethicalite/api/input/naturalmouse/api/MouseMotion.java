...
import dev.unethicalite.api.input.naturalmouse.support.DoublePoint;
...
import dev.unethicalite.api.input.naturalmouse.support.mousemotion.MouseMovement;
import dev.unethicalite.api.input.naturalmouse.support.mousemotion.MovementFactory;
import dev.unethicalite.api.input.naturalmouse.util.MathUtil;
