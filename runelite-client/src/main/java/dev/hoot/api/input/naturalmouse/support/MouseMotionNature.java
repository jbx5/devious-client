...
import dev.hoot.api.input.naturalmouse.api.DeviationProvider;
import dev.hoot.api.input.naturalmouse.api.MouseInfoAccessor;
import dev.hoot.api.input.naturalmouse.api.NoiseProvider;
import dev.hoot.api.input.naturalmouse.api.OvershootManager;
import dev.hoot.api.input.naturalmouse.api.SpeedManager;
