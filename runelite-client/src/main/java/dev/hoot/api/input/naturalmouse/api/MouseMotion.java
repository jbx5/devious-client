...
import dev.hoot.api.input.naturalmouse.support.DoublePoint;
import dev.hoot.api.input.naturalmouse.support.Flow;
import dev.hoot.api.input.naturalmouse.support.MouseMotionNature;
import dev.hoot.api.input.naturalmouse.support.mousemotion.MouseMovement;
import dev.hoot.api.input.naturalmouse.support.mousemotion.MovementFactory;
import dev.hoot.api.input.naturalmouse.util.MathUtil;
