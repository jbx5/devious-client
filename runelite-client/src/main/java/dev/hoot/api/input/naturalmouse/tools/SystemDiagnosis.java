package dev.hoot.api.input.naturalmouse.tools;

import dev.hoot.api.input.naturalmouse.api.MouseInfoAccessor;
import dev.hoot.api.input.naturalmouse.api.SystemCalls;
import dev.hoot.api.input.naturalmouse.support.DefaultMouseInfoAccessor;
import dev.hoot.api.input.naturalmouse.support.DefaultSystemCalls;
