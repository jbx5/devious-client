package dev.hoot.bot.devtools.scriptinspector;
...
public class ScriptInspector
{
	...
	public void open()
	{
		...
		if (frame == null)
		{
			...
			String blacklistConfig = configManager.getConfiguration("hoot", "devtools.blacklist");
			...
			String highlightsConfig = configManager.getConfiguration("hoot", "devtools.highlights");
	...
	public void close()
	{
		configManager.setConfiguration("hoot", "devtools.highlights",
				Text.toCSV(Lists.transform(new ArrayList<>(highlights), String::valueOf)));
		configManager.setConfiguration("hoot", "devtools.blacklist",
