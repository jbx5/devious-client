...
public class ScriptPanel
{
	...
	public void open()
	{
		if (frame == null)
		{
			...
			//startButton
			JButton startButton = new JButton(new ImageIcon(ImageUtil.loadImageResource(BotModule.class, "play_arrow_white_18x18.png")));
			...
			//pauseButton
			JButton pauseButton = new JButton(new ImageIcon(ImageUtil.loadImageResource(BotModule.class, "pause_white_18x18.png")));
			pauseButton.addActionListener(e -> scriptManager.pauseScript());
			northPanel.add(pauseButton);

			//stopButton
			JButton stopButton = new JButton(new ImageIcon(ImageUtil.loadImageResource(BotModule.class, "stop_white_18x18.png")));
			...
			//refreshButton
			JButton refreshButton = new JButton(new ImageIcon(ImageUtil.loadImageResource(BotModule.class, "reset.png")));
